...
import { fontSans, fontMono, fontSyne } from '@/lib/fonts';
...
import { StatsInitializer } from '@/components/providers/stats-initializer';
import ClientObsidianFlux from '@/components/ClientObsidianFlux';
  ...
  return (
    <>
      <html lang="en" suppressHydrationWarning>
        ...
        <body
          className={cn(
            'min-h-svh font-sans antialiased bg-transparent selection:bg-primary selection:text-primary-foreground',
            fontSans.variable,
            fontMono.variable,
            fontSyne.variable
          )}
