...
"[project]/node_modules/p5/dist/type/textCore.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function textCore(p51, fn) {
    ...
    const VariableAxesRe = new RegExp("(?:".concat(VariableAxes.join('|'), ")"));
    const textFunctions = [
        'text',
        'textAlign',
        'textAscent',
   ...
   */ // attach each text func to p5, delegating to the renderer
    textFunctions.forEach((func)=>{
        fn[func] = function() {
            ...
            if (!(func in __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype)) {
                throw Error("Renderer2D.prototype.".concat(func, " is not defined."));
            }
            return this._renderer[func](...args);
        };
        // attach also to p5.Graphics.prototype
        p51.Graphics.prototype[func] = function() {
            for(var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++){
                args[_key] = arguments[_key];
            }
            return this._renderer[func](...args);
    ...
    ////////////////////////////// start API ///////////////////////////////
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype.text = function(str, x, y, width, height) {
   ...
   * @private
   */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype.textBounds = function(str, x, y, width, height) {
   ...
   * @returns - a bounding box object for the text block: {x,y,w,h}
   * @private
   */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype.fontBounds = function(str, x, y, width, height) {
   ...
   * @private
   */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype.textWidth = function(theText) {
   ...
   * @returns - the width of the text in pixels
   * @private
   */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype.fontWidth = function(theText) {
   ...
   * @returns - the ascent of the text
   * @private
   */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype.textAscent = function() {
        let txt = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : '';
   ...
   * @private
   */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype.fontAscent = function() {
   ...
   * @returns - the descent of the text
   * @private
   */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype.textDescent = function() {
        let txt = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : '';
        if (!txt.length) return this.fontDescent();
        return this.textDrawingContext().measureText(txt).actualBoundingBoxDescent;
    };
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype.fontDescent = function() {
        return this.textDrawingContext().measureText('_').fontBoundingBoxDescent;
    };
    // setters/getters for text properties //////////////////////////
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype.textAlign = function(h, v) {
        // the setter
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype._currentTextFont = function() {
   ...
   * @private
   */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype.textFont = function(font, size, options1) {
        ...
        if (font instanceof p51.Font) {
            ...
            if ((_font_name = font.name) === null || _font_name === void 0 ? void 0 : _font_name.fontSubfamily) {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype._directSetFontString = function(font) {
        let debug = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0;
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype.textLeading = function(leading) {
        // the setter
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype.textWeight = function(weight) {
        // the setter
        if (typeof weight === 'number') {
            ...
            if (!p51.prototype._isSafari()) {
                this._setCanvasStyleProperty('font-variation-settings', '"wght" '.concat(weight));
            }
            return;
        }
        // the getter
   ...
   * @private
   */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype.textSize = function(size) {
        // the setter
        if (typeof size !== 'undefined') {
            this._setTextSize(size);
            return this._applyTextProperties();
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype.textStyle = function(style) {
        // the setter
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype.textWrap = function(wrapStyle) {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype.textDirection = function(direction) {
   ...
   * @private
   */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype.textProperty = function(prop, value, opts) {
        let modified = false, debug = (opts === null || opts === void 0 ? void 0 : opts.debug) || false;
   ...
   * @private
   */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype.textProperties = function(properties) {
        // setter
        ...
        Object.keys(RendererTextProps).forEach((p)=>{
            var _RendererTextProps_p;
            if (((_RendererTextProps_p = RendererTextProps[p]) === null || _RendererTextProps_p === void 0 ? void 0 : _RendererTextProps_p.type) === 'Context2d') {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype.textMode = function() {};
    /////////////////////////////// end API ////////////////////////////////
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype._currentTextFont = function() {
        return this.states.textFont.font || this.states.textFont.family;
    };
   ...
   * @private
  */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype._computeBounds = function(type, str, x, y, width, height, opts) {
        let context = this.textDrawingContext();
        ...
        if (lines.length > 1) {
            ...
            if (!(opts === null || opts === void 0 ? void 0 : opts.ignoreRectMode)) {
   ...
   * @private
  */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype._rectModeAdjust = function(x, y, width, height) {
   ...
   * @private
  */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype._setCanvasStyleProperty = function(opt, val, debug) {
   ...
   * @private
  */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype._handleFontVariationSettings = function(value) {
  ...
  */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype._setContextProperty = function(prop, val) {
        let debug = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false;
        ...
        (contextQueue !== null && contextQueue !== void 0 ? contextQueue : contextQueue = []).push([
            prop,
            val
        ]);
  ...
  */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype._handleRectMode = function(x, y, width, height) {
   ...
   * @private
   */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype._fontSizePx = function(theSize) {
        let { family } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.states.textFont;
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype._cachedDiv = function(props) {
   ...
   * @private
  */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype._aggregateBounds = function(bboxes) {
   ...
   * @private
  */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype._processLines = function(str, width, height) {
        if (typeof width !== 'undefined') {
  ...
  */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype._xAlignOffset = function(textAlign, width) {
        switch(textAlign){
            case fn.LEFT:
                return 0;
            case fn.CENTER:
  ...
  */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype._rectModeAlign = function(bb, width, height) {
        if (typeof width !== 'undefined') {
            switch(this.states.rectMode){
                case fn.CENTER:
                    bb.x -= (width - bb.w) / 2;
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype._rectModeAlignRevert = function(bb, width, height) {
        if (typeof width !== 'undefined') {
            switch(this.states.rectMode){
                case fn.CENTER:
                    bb.x += (width - bb.w) / 2;
  ...
  */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype._textWidthSingle = function(s) {
  ...
  */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype._fontWidthSingle = function(s) {
  ...
  */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype._textBoundsSingle = function(s) {
        let x = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, y = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 0;
        let metrics = this.textDrawingContext().measureText(s);
  ...
  */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype._fontBoundsSingle = function(s) {
        let x = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, y = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 0;
        let metrics = this.textDrawingContext().measureText(s);
   ...
   */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype._setTextSize = function(theSize) {
   ...
   * @private
  */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype._lineate = function(textWrap, lines) {
        let maxWidth = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : Infinity, opts = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {};
        var _opts_splitChar;
        let splitter = (_opts_splitChar = opts.splitChar) !== null && _opts_splitChar !== void 0 ? _opts_splitChar : textWrap === fn.WORD ? ' ' : '';
        let line, testLine, testWidth, words, newLines = [];
        for(let lidx = 0; lidx < lines.length; lidx++){
            line = '';
            words = lines[lidx].split(splitter);
            for(let widx = 0; widx < words.length; widx++){
                testLine = "".concat(line + words[widx]) + splitter;
                testWidth = this._textWidthSingle(testLine);
                if (line.length > 0 && testWidth > maxWidth) {
                    newLines.push(line.trim());
                    line = "".concat(words[widx]) + splitter;
                } else {
                    line = testLine;
                }
            }
  ...
  */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype._splitOnBreaks = function(s) {
  ...
  */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype._parseFontFamily = function(familyStr) {
        ...
        let family = parts.map((part)=>{
            ...
            if ((part.indexOf(' ') > -1 || SpecialCharRe.test(part)) && !QuotedRe.test(part)) {
                part = '"'.concat(part, '"'); // quote font names with spaces
            }
            return part;
        }).join(', ');
        return family;
    };
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype._applyFontString = function() {
        /*
    ...
    */ let { textFont, textSize, lineHeight, fontStyle, fontWeight, fontVariant } = this.states;
        ...
        let style = fontStyle !== fn.NORMAL ? "".concat(fontStyle, " ") : '';
        let weight = fontWeight !== fn.NORMAL ? "".concat(fontWeight, " ") : '';
        let variant = fontVariant !== fn.NORMAL ? "".concat(fontVariant, " ") : '';
        let fsize = "".concat(textSize, "px") + (lineHeight !== fn.NORMAL ? "/".concat(lineHeight, " ") : ' ');
        let fontString = "".concat(style).concat(variant).concat(weight).concat(fsize).concat(family).trim();
   ...
   */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"].prototype._applyTextProperties = function() {
        ...
        while(contextQueue === null || contextQueue === void 0 ? void 0 : contextQueue.length){
            let [prop, val] = contextQueue.shift();
            if (debug) console.log('apply context property "' + prop + '" = "' + val + '"');
            context[prop] = val;
            // check if the value was set successfully
            if (context[prop] !== val) {
                console.warn("Unable to set '".concat(prop, "' property on context2d. It may not be supported.")); // FES?
...
"[project]/node_modules/p5/dist/type/unicodeRanges.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/p5/dist/type/lib/Typr.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const pako = {
    inflate: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pako$2f$dist$2f$pako$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["inflate"]
};
var Typr = {};
...
"[project]/node_modules/p5/dist/type/p5.Font.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const validFontTypesRe = new RegExp("\\.(".concat(validFontTypes.join('|'), ")"), 'i');
const extractFontNameRe = new RegExp("([^/]+)(\\.(?:".concat(validFontTypes.join('|'), "))"), 'i');
...
class Font {
   ...
   */ static hasGlyphData(textFont) {
    ...
    fontBounds(str, x, y, width, height, options) {
        var _options_graphics;
        ({ width, height, options } = this._parseArgs(width, height, options));
        let renderer = (options === null || options === void 0 ? void 0 : (_options_graphics = options.graphics) === null || _options_graphics === void 0 ? void 0 : _options_graphics._renderer) || this._pInst._renderer;
   ...
   * }
   */ textToContours(str) {
        let x = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, y = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 0, width = arguments.length > 3 ? arguments[3] : void 0, height = arguments.length > 4 ? arguments[4] : void 0, options = arguments.length > 5 ? arguments[5] : void 0;
        ({ width, height, options } = this._parseArgs(width, height, options));
   ...
   */ textToModel(str, x, y, width, height, options) {
        ({ width, height, options } = this._parseArgs(width, height, options));
        const extrude = (options === null || options === void 0 ? void 0 : options.extrude) || 0;
        ...
        const vertexIndices = {};
        const vertexId = (v)=>"".concat(v.x.toFixed(6), "-").concat(v.y.toFixed(6), "-").concat(v.z.toFixed(6));
        const newVertices = [];
        ...
        for (const face of newFaces){
            for(let off = 0; off < face.length; off++){
                ...
                const id = "".concat(Math.min(a, b), "-").concat(Math.max(a, b));
                if (!seen[id]) seen[id] = [];
                seen[id].push([
                    a,
                    b
        ...
        for (const [a, b] of validEdges){
            ...
            const edgeVector = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](vB.x - vA.x, vB.y - vA.y, vB.z - vA.z);
            const extrudeVector = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](0, 0, extrude);
            const crossProduct = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"].cross(edgeVector, extrudeVector);
            const dist = edgeVector.mag();
            if (crossProduct.mag() < 0.0001 || dist < 0.0001) continue;
            // Front face vertices
            const frontA = extruded.vertices.length;
            extruded.vertices.push(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](vA.x, vA.y, vA.z + half));
            const frontB = extruded.vertices.length;
            extruded.vertices.push(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](vB.x, vB.y, vB.z + half));
        ...
        for (const v of newVertices){
            extruded.vertices.push(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](v.x, v.y, v.z + half));
        }
        for (const face of newFaces){
    ...
    variations() {
        ...
        if (this.data) {
            var _this_face;
            let axes = (_this_face = this.face) === null || _this_face === void 0 ? void 0 : _this_face.axes;
            if (axes) {
                axes.forEach((ax)=>{
    ...
    metadata() {
        var _this_data;
        let meta = ((_this_data = this.data) === null || _this_data === void 0 ? void 0 : _this_data.name) || {};
    ...
    static async list() {
        let log = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : false;
        if (log) {
  ...
  */ _lineateAndPathify(str, x, y, width, height) {
        let options = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : {};
        var _options_graphics, _this_data_head, _this_data;
        let renderer = (options === null || options === void 0 ? void 0 : (_options_graphics = options.graphics) === null || _options_graphics === void 0 ? void 0 : _options_graphics._renderer) || this._pInst._renderer;
        renderer.push();
        renderer.textFont(this);
        // lineate and compute bounds for the text
        let { lines, bounds } = renderer._computeBounds(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$type$2f$textCore$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["textCoreConstants"]._FONT_BOUNDS, str, x, y, width, height, {
            ignoreRectMode: true,
            ...options
        });
        ...
        let uPE = ((_this_data = this.data) === null || _this_data === void 0 ? void 0 : (_this_data_head = _this_data.head) === null || _this_data_head === void 0 ? void 0 : _this_data_head.unitsPerEm) || 1000;
    ...
    _currentAxes(renderer) {
        var _this_data_fvar, _this_data;
        let axs;
        var _this_data_fvar_length;
        if (((_this_data_fvar_length = (_this_data = this.data) === null || _this_data === void 0 ? void 0 : (_this_data_fvar = _this_data.fvar) === null || _this_data_fvar === void 0 ? void 0 : _this_data_fvar.length) !== null && _this_data_fvar_length !== void 0 ? _this_data_fvar_length : 0) > 0) {
            const fontAxes = this.data.fvar[0];
            axs = fontAxes.map((param)=>{
                let [tag, minVal, defaultVal, maxVal, flags, name] = param;
                ...
                if (tag === 'wght') {
                    ...
                    const match = new RegExp("\\b".concat(tag, "s+(d+)")).exec(renderer.textCanvas().style.fontVariationSettings);
                    if (match) {
    ...
    _textToPathPoints(str, x, y, width, height, options) {
        ...
        for(let i = 0; i < cmds.length; i++){
            ...
            if (type !== 'Z') {
                ...
                if (type === 'L' && pts.length && !(options === null || options === void 0 ? void 0 : options.nodivide) > 0) {
    ...
    _position(renderer, lines, bounds, width, height) {
        ...
        let coordify = (text, i)=>{
            ...
            if (textAlign === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["v"]) {
                x += (bounds.w - lineWidth) / 2;
            } else if (textAlign === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a9"]) {
            ...
            if (typeof width !== 'undefined') {
                switch(renderer.states.rectMode){
                    case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["v"]:
                        ...
                        y -= height / 2;
                        break;
                    case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["u"]:
                        x -= width;
                        y -= height;
                        break;
                }
    ...
    _lineToGlyphs(line) {
        let { scale = 1, axs } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
        if (!this.data) {
            throw Error('No font data available for "' + this.name + '"\nTry downloading a local copy of the font file');
        }
        let glyphShapes = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$type$2f$lib$2f$Typr$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].U.shape(this.data, line.text, {
            axs
        });
    ...
    _positionGlyphs(text, options) {
        ...
        let renderer = (options === null || options === void 0 ? void 0 : (_options_graphics = options.graphics) === null || _options_graphics === void 0 ? void 0 : _options_graphics._renderer) || this._pInst._renderer;
        const axs = this._currentAxes(renderer);
        const glyphShapes = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$type$2f$lib$2f$Typr$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].U.shape(this.data, text, {
            axs
        });
    ...
    _singleShapeToPath(shape) {
        let { scale = 1, x = 0, y = 0, lineX = 0, lineY = 0, axs } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
        let font = this.data;
        let crdIdx = 0;
        let { g, ax, ay, dx, dy } = shape;
        let { crds, cmds } = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$type$2f$lib$2f$Typr$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].U.glyphToPath(font, g, true, axs);
    ...
    _shapeToPaths(glyphs, line) {
        let { scale = 1, axs } = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
        let x = 0, y = 0, paths = [];
    ...
    drawPaths(ctx, commands, opts) {
        ctx.strokeStyle = (opts === null || opts === void 0 ? void 0 : opts.stroke) || ctx.strokeStyle;
        ctx.fillStyle = (opts === null || opts === void 0 ? void 0 : opts.fill) || ctx.fillStyle;
        ctx.beginPath();
        ...
        if (opts === null || opts === void 0 ? void 0 : opts.fill) ctx.fill();
        if (opts === null || opts === void 0 ? void 0 : opts.stroke) ctx.stroke();
    }
...
function createFontFace(name, path, descriptors, rawFont) {
    ...
    var _rawFont__compressedData;
    let fontArg = (_rawFont__compressedData = rawFont === null || rawFont === void 0 ? void 0 : rawFont._compressedData) !== null && _rawFont__compressedData !== void 0 ? _rawFont__compressedData : rawFont === null || rawFont === void 0 ? void 0 : rawFont._data;
    if (!fontArg) {
    ...
    var _rawFont_fvar_length;
    if (((_rawFont_fvar_length = rawFont === null || rawFont === void 0 ? void 0 : (_rawFont_fvar = rawFont.fvar) === null || _rawFont_fvar === void 0 ? void 0 : _rawFont_fvar.length) !== null && _rawFont_fvar_length !== void 0 ? _rawFont_fvar_length : 0) > 0) {
        descriptors = descriptors || {};
        for (const [tag, minVal, defaultVal, maxVal, flags, name] of rawFont.fvar[0]){
            if (tag === 'wght') {
                descriptors.weight = "".concat(minVal, " ").concat(maxVal);
            } else if (tag === 'wdth') {
                descriptors.stretch = "".concat(minVal, "% ").concat(maxVal, "%");
            }
...
function extractFontName(font, path) {
    let result, meta = font === null || font === void 0 ? void 0 : font.name;
...
function pathToPoints(cmds, options, font) {
    ...
    const path = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$davepagurek$2f$bezier$2d$path$2f$build$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createFromCommands"])(arrayCommandsToObjects(cmds));
...
function parseCreateArgs() {
    for(var _len /*path, name, onSuccess, onError*/  = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++){
        args[_key] = arguments[_key];
    }
    // parse the path
    let path = args.shift();
...
function font(p51, fn1) {
   ...
   */ fn1.parseFontData = async function(pathOrData) {
        ...
        // parse the font data
        let fonts = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$type$2f$lib$2f$Typr$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].parse(result);
   ...
   */ fn1.loadFont = async function() {
        ...
        if (!isCSS) {
            ...
            const isCSSFile = (_info_headers_get = info.headers.get('content-type')) === null || _info_headers_get === void 0 ? void 0 : _info_headers_get.startsWith('text/css');
            if (isCSSFile) {
                isCSS = true;
        ...
        if (isCSS) {
            ...
            for (const rule of stylesheet.cssRules){
                if (rule instanceof CSSFontFaceRule) {
                    ...
                    for (const key of style){
                        ...
                        const camelCaseKey = key.replace(/^font-/, '').split('-').map((v, i)=>i === 0 ? v : "".concat(v[0].toUpperCase()).concat(v.slice(1))).join('');
            ...
            const requestedCategories = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$type$2f$unicodeRanges$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["unicodeRanges"].filter((r)=>requestedGroups.some((g)=>r.category.includes(g) && // Only include extended character sets if specifically requested
                    r.category.includes('ext') === g.includes('ext')));
            const requestedRanges = new Set(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$japont$2f$unicode$2d$range$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UnicodeRange"].parse(requestedCategories.map((c)=>"U+".concat(c.hexrange[0], "-").concat(c.hexrange[1]))));
            ...
            for (const font of possibleFonts){
                ...
                const fontRange = new Set(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$japont$2f$unicode$2d$range$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UnicodeRange"].parse(font.fontDescriptors.unicodeRange.split(/,\s*/g)));
                const rangeOverlap = [
                    ...fontRange.values()
            ...
            return picked === null || picked === void 0 ? void 0 : picked.loadWithData();
        }
        let pfont;
        try {
            ...
            console.warn("WARN: No glyph data for '".concat(ident, "', retrying as FontFace"));
            try {
...
const arrayCommandsToObjects = (commands)=>commands.map((command)=>{
        ...
        switch(type){
            ...
            default:
                {
                    throw new Error("Unexpected path command: ".concat(type));
                }
        }
    });
if (typeof p5 !== 'undefined') {
...
"[project]/node_modules/p5/dist/type/index.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
function type(p5) {
    p5.registerAddon(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$type$2f$textCore$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]);
    p5.registerAddon(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$type$2f$p5$2e$Font$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]);
}
;
}),
]);

//# sourceMappingURL=node_modules_p5_dist_type_6c91a352._.js.map