...
"[project]/node_modules/p5/dist/dom/p5.File.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    static _createLoader(theFile, callback) {
        ...
        reader.onload = function(e) {
            ...
            if (p5file.file.type === 'application/json') {
                ...
                p5file.data = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$io$2f$p5$2e$XML$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["XML"](xml.documentElement);
            } else {
...
"[project]/node_modules/p5/dist/dom/p5.Element.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ class Element {
   ...
   */ size(w, h) {
        if (arguments.length === 0) {
            ...
            let aW = w;
            let aH = h;
            const AUTO$1 = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a4"];
   ...
   */ style(prop, val) {
        const self = this;
        if (val instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$creating_reading$2d$C7hu6sg1$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["C"]) {
            val = val.toString();
        }
    ...
    /* Helper method called by p5.Element.style() */ _translate() {
        for(var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++){
            args[_key] = arguments[_key];
        }
    ...
    /* Helper method called by p5.Element.style() */ _rotate() {
        for(var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++){
            args[_key] = arguments[_key];
        }
        ...
        if (window.File && window.FileReader && window.FileList && window.Blob) {
            ...
            Element._attachListener('drop', function(evt) {
                ...
                for (const f of files){
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$File$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["File"]._load(f, callback);
                }
            }, this);
        } else {
   ...
   */ static _detachListener(ev, ctx) {
    ...
    constructor(elt, pInst){
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "elt", void 0);
        this.elt = elt;
...
"[project]/node_modules/p5/dist/dom/p5.MediaElement.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class MediaElement extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$Element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Element"] {
    /**
        ...
        if (promise && promise.catch) {
            promise.catch((e1)=>{
                ...
                if (e1.name === 'NotAllowedError') {
                    ...
                    console.error('Media play method encountered an unexpected error', e1);
                }
            });
        }
        return this;
   ...
   */ onended(callback) {
    ...
    /*** CONNECT TO WEB AUDIO API / p5.sound.js ***/ _getAudioContext() {
        return undefined;
    }
    _getSoundOut() {
        return undefined;
...
function media(p51, fn) {
    /**
   * Helpers for create methods.
   */ function addElement(elt, pInst, media) {
        const node = pInst._userNode ? pInst._userNode : document.body;
        node.appendChild(elt);
        const c = media ? new MediaElement(elt, pInst) : new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$Element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Element"](elt, pInst);
   ...
   */ fn.createCapture = function() {
        ...
        navigator.mediaDevices.getUserMedia(constraints).then(function(stream) {
            ...
            if (e1.name === 'NotFoundError') p51._friendlyError('No webcam found on this device', 'createCapture');
            if (e1.name === 'NotAllowedError') p51._friendlyError('Access to the camera was denied', 'createCapture');
            console.error(e1);
        });
...
"[project]/node_modules/p5/dist/dom/dom.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ function dom(p51, fn) {
   ...
   */ fn._getContainer = function(p) {
        ...
        } else if (p instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$Element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Element"]) {
            container = p.elt;
   ...
   */ fn._wrapElement = function(elt) {
        ...
        if (elt.tagName === 'INPUT' && elt.type === 'checkbox') {
            let converted = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$Element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Element"](elt, this);
            ...
            return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$MediaElement$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MediaElement"](elt, this);
        } else if (elt.tagName === 'SELECT') {
            return this.createSelect(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$Element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Element"](elt, this));
        } else if (children.length > 0 && children.every(function(c) {
            return c.tagName === 'INPUT' || c.tagName === 'LABEL';
        }) && (elt.tagName === 'DIV' || elt.tagName === 'SPAN')) {
            return this.createRadio(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$Element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Element"](elt, this));
        } else {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$Element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Element"](elt, this);
        }
    };
    /**
   ...
   */ function addElement(elt, pInst, media) {
        const node = pInst._userNode ? pInst._userNode : document.body;
        node.appendChild(elt);
        const c = media ? new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$MediaElement$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MediaElement"](elt, pInst) : new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$Element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Element"](elt, pInst);
        pInst._elements.push(c);
        return c;
    }
    /**
   ...
   */ fn.createDiv = function() {
        let html = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : '';
   ...
   */ fn.createSelect = function() {
        ...
        let self;
        let arg = args[0];
        if (arg instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$Element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Element"] && arg.elt instanceof HTMLSelectElement) {
   ...
   */ //counter for unique names on radio button
    ...
    fn.createRadio = function() {
        ...
        let name;
        const arg0 = args[0];
        if (arg0 instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$Element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Element"] && (arg0.elt instanceof HTMLDivElement || arg0.elt instanceof HTMLSpanElement)) {
        ...
        self._name = name || "radioOption_".concat(counter++);
        ...
        self.disable = function() {
            let shouldDisable = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true;
   ...
   */ fn.createColorPicker = function(value) {
        ...
        self.color = function() {
            ...
            if (value) {
                if (value.mode) {
                    inst.colorMode(value.mode, ...(value === null || value === void 0 ? void 0 : value.maxes) ? value.maxes[value.mode] || [] : []);
                }
            }
   ...
   * @param {String} [value]
   * @return {p5.Element}
   */ fn.createInput = function() {
        let value = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : '', type = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 'text';
   ...
   *   }
   * }
   */ fn.createFileInput = function(callback) {
        let multiple = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
        // p5._validateParameters('createFileInput', arguments);
        const handleFileSelect = function(event) {
            for (const file of event.target.files){
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$File$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["File"]._load(file, callback);
            }
        };
        // If File API's are not supported, throw Error
        if (!(window.File && window.FileReader && window.FileList && window.Blob)) {
            p51._friendlyError('The File APIs are not fully supported in this browser. Cannot create element.', 'createFileInput');
            return;
        }
...
"[project]/node_modules/p5/dist/dom/index.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
function dom(p5) {
    p5.registerAddon(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$dom$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]);
    p5.registerAddon(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$Element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]);
    p5.registerAddon(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$MediaElement$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]);
    p5.registerAddon(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$File$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]);
}
;
}),
]);

//# sourceMappingURL=node_modules_p5_dist_dom_50efaeb3._.js.map