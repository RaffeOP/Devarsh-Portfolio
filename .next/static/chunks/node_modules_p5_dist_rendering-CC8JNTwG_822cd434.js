...
"[project]/node_modules/p5/dist/rendering-CC8JNTwG.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ function image(p51, fn) {
   ...
   */ fn.createImage = function(width, height) {
        ...
        return new p51.Image(width, height);
    };
    /**
   ...
   */ fn.saveCanvas = function() {
        ...
        if (args[0] instanceof HTMLCanvasElement) {
            htmlCanvas = args[0];
            args.shift();
        } else if (args[0] instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$Element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Element"]) {
        ...
        extension = extension || fn._checkFileExtension(filename, extension)[1] || 'png';
        let mimeType;
        switch(extension){
            default:
                //case 'png':
    ...
    fn.encodeAndDownloadGif = function(pImg, filename) {
        ...
        const gifWriter = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$omggif$2f$omggif$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GifWriter"](buffer, pImg.width, pImg.height, opts);
        let previousFrame = {};
        // Pass 2
 ...
 */ class HTTPError extends Error {
    constructor(...args){
        super(...args), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "status", void 0), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "response", void 0), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "ok", void 0);
    }
}
...
function files(p51, fn) {
   ...
   */ fn.loadJSON = async function(path, successCallback, errorCallback) {
        ...
        try {
            ...
            p51._friendlyFileLoadError(5, path);
            if (errorCallback) {
   ...
   */ fn.loadTable = async function(path, separator, header, successCallback, errorCallback) {
        ...
        try {
            let { data } = await request(path, 'text');
            const cb = ()=>{
                let ret = new p51.Table();
                data = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$io$2f$csv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parse"])(data, {
                    separator
                });
                if (header) {
                ...
                data.forEach((line)=>{
                    const row = new p51.TableRow(line);
                    ret.addRow(row);
                });
                if (successCallback) {
            ...
            p51._friendlyFileLoadError(2, path);
            if (errorCallback) {
                return errorCallback(err);
            } else {
                throw err;
   ...
   */ fn.loadXML = async function(path, successCallback, errorCallback) {
        try {
            ...
            const cb = ()=>{
                ...
                data = new p51.XML(parsedDOM);
                if (successCallback) return successCallback(data);
                return data;
            };
            return this._internal ? this._internal(cb) : cb();
        } catch (err) {
            p51._friendlyFileLoadError(1, path);
            if (errorCallback) {
                return errorCallback(err);
            } else {
                throw err;
   ...
   */ fn.loadBytes = async function(path, successCallback, errorCallback) {
        try {
            ...
            p51._friendlyFileLoadError(6, path);
            if (errorCallback) {
                return errorCallback(err);
            } else {
                throw err;
   ...
   * @return {Promise}
   */ fn.httpGet = async function(path) {
        let datatype = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 'text', successCallback = arguments.length > 2 ? arguments[2] : void 0, errorCallback = arguments.length > 3 ? arguments[3] : void 0;
   ...
   * @param  {Function}         [errorCallback]
   * @return {Promise}
   */ fn.httpPost = async function(path, data) {
        let datatype = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 'text', successCallback = arguments.length > 3 ? arguments[3] : void 0, errorCallback = arguments.length > 4 ? arguments[4] : void 0;
        ...
        // Normalize data
        if (data instanceof p51.XML) {
            reqData = data.serialize();
            contentType = 'application/xml';
        } else if (data instanceof p51.Image) {
   ...
   */ fn.createWriter = function(name, extension) {
        ...
        for(const i in fn._pWriters){
            if (fn._pWriters[i].name === name) {
                ...
                newPW = new p51.PrintWriter(name + this.millis(), extension);
                fn._pWriters.push(newPW);
                return newPW;
            }
        }
        newPW = new p51.PrintWriter(name, extension);
        fn._pWriters.push(newPW);
        return newPW;
    };
    /**
   ...
   *   myWriter.close();
   * }
   */ p51.PrintWriter = function(filename, extension) {
        let self = this;
        this.name = filename;
        this.content = '';
        /**
   ...
   */ fn.save = function(object, _filename, _options) {
        ...
        if (args.length === 0) {
            fn.saveCanvas(cnv);
            return;
        } else if (args[0] instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"] || args[0] instanceof Graphics) {
            ...
            const extension = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$io$2f$utilities$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_checkFileExtension"])(args[1], args[2])[1];
            switch(extension){
                case 'json':
                ...
                default:
                    if (args[0] instanceof Array) {
                        fn.saveStrings(args[0], args[1], args[2]);
                    } else if (args[0] instanceof p51.Table) {
                        fn.saveTable(args[0], args[1], args[2]);
                    } else if (args[0] instanceof p51.Image) {
                        fn.saveCanvas(args[0].canvas, args[1]);
                    } else if (args[0] instanceof p51.SoundFile) {
   ...
   */ fn.saveStrings = function(list, filename, extension, isCRLF) {
        ...
        const pWriter = new p51.PrintWriter(filename, ext);
   ...
   *  @param  {String} [filename]
   *  @param  {String} [extension]
   */ fn.downloadFile = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$io$2f$utilities$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["downloadFile"];
    /**
   ...
   *
   *  @private
   */ fn._checkFileExtension = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$io$2f$utilities$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_checkFileExtension"];
    /**
 ...
 * @for p5
 * @requires core
 */ function loadingDisplaying(p51, fn) {
    /**
   ...
   */ fn.loadImage = async function(path, successCallback, failureCallback) {
        ...
        try {
            let pImg = new p51.Image(1, 1, this);
            const req = new Request(path, {
                method: 'GET',
                mode: 'cors'
            });
            ...
            p51._friendlyFileLoadError(0, path);
   ...
   *   }
   * }
   */ fn.saveGif = async function(fileName, duration) {
        ...
        let pixels;
        let gl;
        if (this._renderer instanceof p51.RendererGL) {
      ...
      */ this.redraw();
        ...
        const gif = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gifenc$2f$dist$2f$gifenc$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GIFEncoder"])();
        ...
        const getIndexedFrame = (frame)=>{
            ...
            for(let i = 0; i < length; i++){
                ...
                if (paletteCache[key] === undefined) {
                    paletteCache[key] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gifenc$2f$dist$2f$gifenc$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["nearestColorIndex"])(globalPalette, frame.slice(i * 4, (i + 1) * 4));
                }
        ...
        if (!silent) {
            ...
            if (notificationDuration > 0) setTimeout(()=>p.remove(), notificationDuration * 1000);
        }
        fn.downloadFile(blob, fileName, extension);
    };
    ...
    function _generateGlobalPalette(frames) {
        ...
        let colorPalette = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gifenc$2f$dist$2f$gifenc$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["quantize"])(allColors, 256, {
            format: 'rgba4444',
            oneBitAlpha: true
        });
   ...
   */ async function _createGif(arrayBuffer, pImg) {
        ...
        const gifReader = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$omggif$2f$omggif$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GifReader"](arrayBuffer);
        ...
        const loadGIFFrameIntoImage = (frameNum, gifReader)=>{
            try {
                ...
                p51._friendlyFileLoadError(8, pImg.src);
                throw e;
            }
        };
   ...
   */ function _imageContain(xAlign, yAlign, dx, dy, dw, dh, sw, sh) {
        ...
        const [adjusted_dw, adjusted_dh] = [
            sw / r,
            sh / r
        ];
        let x = dx;
        let y = dy;
        if (xAlign === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["v"]) {
            x += (dw - adjusted_dw) / 2;
        } else if (xAlign === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a9"]) {
            x += dw - adjusted_dw;
        }
        if (yAlign === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["v"]) {
            y += (dh - adjusted_dh) / 2;
        } else if (yAlign === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aw"]) {
            y += dh - adjusted_dh;
        }
        return {
            x,
   ...
   */ function _imageFit(fit, xAlign, yAlign, dx, dy, dw, dh, sx, sy, sw, sh) {
        if (fit === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aB"]) {
        ...
        if (fit === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aC"]) {
   ...
   */ fn.image = function(img, dx, dy, dWidth, dHeight, sx, sy, sWidth, sHeight, fit, xAlign, yAlign) {
        // set defaults per spec: https://goo.gl/3ykfOq
        // p5._validateParameters('image', arguments);
        let defW = img.width;
        let defH = img.height;
        yAlign = yAlign || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["v"];
        xAlign = xAlign || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["v"];
        if (img.elt) {
        ...
        _sh *= pd;
        _sw *= pd;
        let vals = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$core$2f$helpers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].modeAdjust(_dx, _dy, _dw, _dh, this._renderer.states.imageMode);
   ...
   */ fn.imageMode = function(m) {
        ...
        if (m === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["p"] || m === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"] || m === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["v"]) {
 ...
 */ class Camera {
   ...
   */ perspective(fovy, aspect, near, far) {
        ...
        this.cameraFar = far;
        this.projMatrix = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$Matrices$2f$Matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Matrix"](4);
        ...
        this.projMatrix.set(f / aspect, 0, 0, 0, 0, -f * this.yScale, 0, 0, 0, 0, A, -1, 0, 0, B, 0);
        if (this._isActive()) {
   ...
   */ _rotateView(a, x, y, z) {
        ...
        centerY -= this.eyeY;
        centerZ -= this.eyeZ;
        const rotation = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$Matrices$2f$Matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Matrix"](4); // TODO Maybe pass p5
   ...
   */ roll(amount) {
        ...
        const axisQuaternion = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$Quat$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Quat"].fromAxisAngle(this._renderer._pInst._toRadians(amount), local.z[0], local.z[1], local.z[2]);
        // const upQuat = new p5.Quat(0, this.upX, this.upY, this.upZ);
        const newUpVector = axisQuaternion.rotateVector(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](this.upX, this.upY, this.upZ));
   ...
   */ slerp(cam0, cam1, amt) {
        ...
        const eye0 = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](cam0.eyeX, cam0.eyeY, cam0.eyeZ);
        const eye1 = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](cam1.eyeX, cam1.eyeY, cam1.eyeZ);
        const center0 = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](cam0.centerX, cam0.centerY, cam0.centerZ);
        const center1 = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](cam1.centerX, cam1.centerY, cam1.centerZ);
        // Calculate the distance between eye and center for each camera.
        // Logarithmically interpolate these with amt.
        const dist0 = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"].dist(eye0, center0);
        const dist1 = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"].dist(eye1, center1);
        ...
        const eyeDiff = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"].sub(eye0, eye1);
        ...
        let ratio = 1; // default.
        if (divider > 0.000001) {
            ratio = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"].dot(eyeDiff, diffDiff) / divider;
        ...
        const lerpedMedium = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"].lerp(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"].lerp(eye0, center0, ratio), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"].lerp(eye1, center1, ratio), amt);
        ...
        // prepare new vectors.
        const newFront = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"]();
        const newUp = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"]();
        const newEye = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"]();
        const newCenter = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"]();
        ...
        if (1 - cosTheta < 0.0000001) {
            ...
            newFront.set(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"].lerp(front0, front1, amt)).normalize();
            ...
            newUp.set(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"].lerp(up0, up1, amt)).normalize();
            // set the camera
        ...
        const ca = c * a;
        // 3x3
        const lerpedRotMat = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$Matrices$2f$Matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Matrix"]([
   ...
   */ _orbit(dTheta, dPhi, dRadius) {
        ...
        const front = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](diffX, diffY, diffZ).normalize();
        // up vector. normalized camera's up vector.
        const up = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](this.upX, this.upY, this.upZ).normalize(); // y-axis
        // side vector. Right when viewed from the front
        const side = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"].cross(up, front).normalize(); // x-axis
        // vertical vector. normalized vector of projection of front vector.
        const vertical = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"].cross(side, up); // z-axis
        // update camRadius
        ...
        const camPhi = Math.acos(Math.max(-1, Math.min(1, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"].dot(front, up)))) + dPhi;
   ...
   */ _orbitFree(dx, dy, dRadius) {
        ...
        const up = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](this.upX, this.upY, this.upZ);
        // side vector. Right when viewed from the front. (like x-axis)
        const side = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"].cross(up, front).normalize();
        // down vector. Bottom when viewed from the front. (like y-axis)
        const down = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"].cross(front, side);
        ...
        const axis = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"].cross(front, side);
        // update camRadius
        camRadius *= Math.pow(10, dRadius);
        // prevent zooming through the center:
        if (camRadius < this.cameraNear) {
   ...
   */ _isActive() {
    ...
    constructor(renderer){
        ...
        this.cameraMatrix = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$Matrices$2f$Matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Matrix"](4);
        this.projMatrix = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$Matrices$2f$Matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Matrix"](4);
        this.yScale = 1;
    }
}
function camera(p51, fn) {
    ////////////////////////////////////////////////////////////////////////////////
   ...
   * }
   */ p51.Camera = Camera;
    Renderer3D.prototype.camera = function() {
        for(var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++){
            args[_key] = arguments[_key];
        }
    ...
    Renderer3D.prototype.perspective = function() {
        for(var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++){
            args[_key] = arguments[_key];
        }
        this.states.setValue('curCamera', this.states.curCamera.clone());
    ...
    Renderer3D.prototype.ortho = function() {
        for(var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++){
            args[_key] = arguments[_key];
        }
        this.states.setValue('curCamera', this.states.curCamera.clone());
    ...
    Renderer3D.prototype.frustum = function() {
        for(var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++){
            args[_key] = arguments[_key];
        }
        this.states.setValue('curCamera', this.states.curCamera.clone());
...
const { STROKE_CAP_ENUM, STROKE_JOIN_ENUM } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$enums$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getStrokeDefs"])(()=>"");
class Renderer3D extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"] {
    //This is helper function to reset the context anytime the attributes
    //are changed with setAttributes()
    async _resetContext(options, callback) {
        let ctor = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : Renderer3D;
        const w = this.width;
        const h = this.height;
        ...
        if (isPGraphics) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$Element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Element"].call(pg, pg.canvas, pg._pInst);
        ...
        const renderer = new ctor(this._pInst, w, h, !isPGraphics, this._pInst.canvas);
   ...
   */ beginGeometry() {
        ...
        this.geometryBuilder = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$GeometryBuilder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"](this);
        this.geometryBuilder.prevFillColor = this.states.fillColor;
        this.fill(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$creating_reading$2d$C7hu6sg1$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["C"]([
            -1,
            -1,
            -1,
            -1
   ...
   */ buildGeometry(callback) {
    ...
    drawShape(shape) {
        const visitor = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$shape$2f$custom_shapes$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PrimitiveToVerticesConverter"]({
            curveDetail: this.states.curveDetail
        });
        shape.accept(visitor);
        this.shapeBuilder.constructFromContours(shape, visitor.contours);
        if (this.geometryBuilder) {
            this.geometryBuilder.addImmediate(this.shapeBuilder.geometry, this.shapeBuilder.shapeMode, {
    ...
    normal(xorv, y, z) {
        if (xorv instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"]) {
            this.states.setValue("_currentNormal", xorv);
        } else {
            this.states.setValue("_currentNormal", new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](xorv, y, z));
        }
    ...
    _drawGeometry(geometry) {
        let { mode = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"], count = 1 } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
        for(const propName in geometry.userVertexProperties){
            const prop = geometry.userVertexProperties[propName];
            this.buffers.user.push(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$RenderBuffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RenderBuffer"](prop.getDataSize(), prop.getSrcName(), prop.getDstName(), prop.getName(), this));
        }
        if (this.states.fillColor && geometry.vertices.length >= 3 && ![
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Y"],
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["X"]
        ].includes(mode)) {
            this._drawFills(geometry, {
                mode,
                count
            });
        }
        if (this.states.strokeColor && geometry.lineVertices.length >= 1) {
            this._drawStrokes(geometry, {
                count
            });
        }
        this.buffers.user = [];
    ...
    _drawFills(geometry) {
        let { count, mode } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
        this._useVertexColor = geometry.vertexColors.length > 0 && !geometry.vertexColors.isDefault;
        const shader = !this._drawingFilter && this.states.userFillShader ? this.states.userFillShader : this._getFillShader();
        ...
        this._applyColorBlend(this.states.curFillColor, geometry.hasFillTransparency());
        this._drawBuffers(geometry, {
            mode,
            count
        });
        shader.unbindShader();
    }
    _drawStrokes(geometry) {
        ...
        this._prepareUserAttributes(geometry, shader);
        this._disableRemainingAttributes(shader);
        this._applyColorBlend(this.states.curStrokeColor, geometry.hasStrokeTransparency());
        this._drawBuffers(geometry, {
            count
        });
        shader.unbindShader();
            ...
            if (!this._pInst.constructor.disableFriendleErrors) {
                ...
                if (prop) {
                    ...
                    if (adjustedLength > geometry.vertices.length) {
                        this._pInst.constructor._friendlyError("One of the geometries has a custom vertex property '".concat(prop.getName(), "' with more values than vertices. This is probably caused by directly using the Geometry.vertexProperty() method."), "vertexProperty()");
                    } else if (adjustedLength < geometry.vertices.length) {
                        this._pInst.constructor._friendlyError("One of the geometries has a custom vertex property '".concat(prop.getName(), "' with fewer values than vertices. This is probably caused by directly using the Geometry.vertexProperty() method."), "vertexProperty()");
                    }
                }
            }
            buff._prepareBuffer(geometry, shader);
    ...
    background() {
        ...
        if (isImageLike) {
            ...
            this._pInst.imageMode(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["v"]);
   ...
   */ getWorldToScreenMatrix() {
        ...
        const projectedToScreenMatrix = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$Matrices$2f$Matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Matrix"](4);
   ...
   */ fill() {
        ...
        this.states.setValue('drawMode', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aD"]);
   ...
   */ stroke() {
    ...
    filter() {
        ...
        if (typeof args[0] === 'string') {
            operation = args[0];
            let useDefaultParam = operation in __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$image$2f$const$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["filterParamDefaults"] && args[1] === undefined;
            filterParameter = useDefaultParam ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$image$2f$const$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["filterParamDefaults"][operation] : args[1];
        ...
        if (operation === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ab"]) {
            ...
            tmp.draw(()=>{
                this.states.filterShader.setUniform('direction', [
                    1,
                    0
                ]);
        ...
        this.clear();
        this.push();
        this.states.setValue('imageMode', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["p"]);
        this.blendMode(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["B"]);
   ...
   */ _getTempFramebuffer() {
        if (!this._tempFramebuffer) {
            this._tempFramebuffer = new Framebuffer(this, {
                format: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["U"],
                useDepth: this._pInst._glAttributes.depth,
                depthFormat: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["d"],
   ...
   */ resize(w, h) {
        ...
        for (const framebuffer of this.framebuffers){
            var // Notify framebuffers of the resize so that any auto-sized framebuffers
            // can also update their size
            _this_flushDraw1, _this1;
            (_this_flushDraw1 = (_this1 = this).flushDraw) === null || _this_flushDraw1 === void 0 ? void 0 : _this_flushDraw1.call(_this1);
            framebuffer._canvasSizeChanged();
        }
        (_this_flushDraw = (_this = this).flushDraw) === null || _this_flushDraw === void 0 ? void 0 : _this_flushDraw.call(_this);
    ...
    applyMatrix(a, b, c, d, e, f) {
        ...
        if (arguments.length === 16) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$Matrices$2f$Matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Matrix"].prototype.apply.apply(this.states.uModelMatrix, arguments);
        } else {
   ...
   */ scale(x, y, z) {
    ...
    rotate(rad, axis) {
        ...
        this.states.setValue("uModelMatrix", this.states.uModelMatrix.clone());
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$Matrices$2f$Matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Matrix"].prototype.rotate4x4.apply(this.states.uModelMatrix, arguments);
        return this;
    }
    rotateX(rad) {
   ...
   */ activeFramebuffer() {
    ...
    _setGlobalUniforms(shader) {
        ...
        const projectionMatrix = this.states.uPMatrix;
        const modelViewMatrix = modelMatrix.copy().mult(viewMatrix);
        shader.setUniform("uPerspective", this.states.curCamera.useLinePerspective ? 1 : 0);
        ...
        if (shader.uniforms.uModelViewProjectionMatrix) {
            ...
            shader.setUniform("uModelViewProjectionMatrix", modelViewProjectionMatrix.mat4);
        }
    ...
    _setFillUniforms(fillShader) {
        ...
        for(let i = 0; i < this.states.ambientLightColors.length; i += 3){
            for(let off = 0; off < 3; off++){
                if (this.states._useMetalness > 0) {
                    mixedAmbientLight[off] += Math.max(0, this.states.ambientLightColors[i + off] - this.states._useMetalness);
                } else {
   ...
   */ _getEmptyTexture() {
    ...
    // Buffers
    //////////////////////////////////////////////
    _normalizeBufferData(values) {
        let type = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Float32Array;
        if (!values) return null;
        if (values instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$DataArray$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DataArray"]) {
   ...
   */ _vToNArray(arr) {
    ...
    _yAlignOffset(dataArr, height) {
        ...
        switch(textBaseline){
            ...
            case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aw"]:
                ...
                break;
            default:
                console.warn("".concat(textBaseline, " is not supported in WebGL mode.")); // FES?
                break;
        }
    ...
    _makeFilterShader(renderer, operation) {
        const p51 = this._pInst;
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$core$2f$filterShaders$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["makeFilterShader"])(this, operation, p51);
    }
    /*
   ...
   */ makeSpecularTexture(input) {
        ...
        for(let w = size; w >= 1; w /= 2){
            ...
            framebuffer.draw(()=>{
                ...
                this.clear();
                this._setImageLightShaderUniforms(this.specularShader, input, roughness);
                this.states.setValue("strokeColor", null);
                this.noLights();
                this.plane(w, w);
            });
    ...
    _getSphereMapping(img) {
        if (!this.sphereMapping) {
            const p51 = this._pInst;
            this.sphereMapping = this.baseFilterShader().modify((param)=>{
                let { p5: p51 } = param;
                const uEnvMap = p51.uniformTexture('uEnvMap');
                const uFovY = p51.uniformFloat('uFovY');
                const uAspect = p51.uniformFloat('uAspect');
                // Hack: we don't have matrix uniforms yet; use three vectors
                const uN1 = p51.uniformVec3('uN1');
                const uN2 = p51.uniformVec3('uN2');
                const uN3 = p51.uniformVec3('uN3');
                p51.getColor((inputs)=>{
                    const uFovX = uFovY * uAspect;
                    const angleY = p51.mix(uFovY / 2.0, -uFovY / 2.0, inputs.texCoord.y);
                    const angleX = p51.mix(uFovX / 2.0, -uFovX / 2.0, inputs.texCoord.x);
                    let rotatedNormal = p51.normalize([
                        angleX,
                        angleY,
                        1
                    ]);
                    rotatedNormal = [
                        ...
                        p51.dot(rotatedNormal, uN1),
                        p51.dot(rotatedNormal, uN2),
                        p51.dot(rotatedNormal, uN3)
                    ];
                    const temp = rotatedNormal.z;
                    rotatedNormal.z = rotatedNormal.x;
                    rotatedNormal.x = -temp;
                    const suv = [
                        p51.atan(rotatedNormal.z, rotatedNormal.x) / (2.0 * p51.PI) + 0.5,
                        0.5 + 0.5 * -rotatedNormal.y
                    ];
                    return p51.getTexture(uEnvMap, suv);
                });
            }, {
                p5: p51
            });
        ...
        this.sphereMapping.setUniform("uN1", [
            m[0],
            m[3],
            m[6]
        ]);
        this.sphereMapping.setUniform("uN2", [
            m[1],
            m[4],
            m[7]
        ]);
        this.sphereMapping.setUniform("uN3", [
            m[2],
            m[5],
            m[8]
        ]);
   ...
   */ _createImageLightShader(type) {
        throw new Error("_createImageLightShader must be implemented by the renderer");
    }
    ...
    _finalizeMipmapTexture(mipmapData) {
        throw new Error("_finalizeMipmapTexture must be implemented by the renderer");
    }
    remove() {
        if (this._textCanvas) {
    ...
    constructor(pInst, w, h, isMainCanvas, elt){
        super(pInst, w, h, isMainCanvas), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "_verticalAlignFont", function() {
        ...
        this.geometryBuilder = undefined;
        // Push/pop state
        this.states.uModelMatrix = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$Matrices$2f$Matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Matrix"](4);
        this.states.uViewMatrix = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$Matrices$2f$Matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Matrix"](4);
        this.states.uPMatrix = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$Matrices$2f$Matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Matrix"](4);
        ...
        this.states.curBlendMode = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["B"];
        ...
        this.states._currentNormal = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](0, 0, 1);
        this.states.drawMode = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aD"];
        this.states._tex = null;
        this.states.textureMode = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ad"];
        this.states.textureWrapX = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["C"];
        this.states.textureWrapY = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["C"];
        // erasing
        this._isErasing = false;
        // simple lines
        ...
        this.zoomVelocity = 0;
        this.rotateVelocity = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](0, 0);
        this.moveVelocity = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](0, 0);
        ...
        this.shapeBuilder = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$ShapeBuilder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ShapeBuilder"](this);
        this.geometryBufferCache = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$GeometryBufferCache$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GeometryBufferCache"](this);
        this.curStrokeCap = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["w"];
        this.curStrokeJoin = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["w"];
        ...
        this.drawShapeCount = 1;
        this.scratchMat3 = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$Matrices$2f$Matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Matrix"](3);
        ...
        this.buffers = {
            fill: [
                new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$RenderBuffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RenderBuffer"](3, "vertices", "vertexBuffer", "aPosition", this, this._vToNArray),
                new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$RenderBuffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RenderBuffer"](3, "vertexNormals", "normalBuffer", "aNormal", this, this._vToNArray),
                new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$RenderBuffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RenderBuffer"](4, "vertexColors", "colorBuffer", "aVertexColor", this).default((geometry)=>geometry.vertices.flatMap(()=>[
                            -1,
                            -1,
                            -1,
                            -1
                        ])),
                new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$RenderBuffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RenderBuffer"](3, "vertexAmbients", "ambientBuffer", "aAmbientColor", this),
                new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$RenderBuffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RenderBuffer"](2, "uvs", "uvBuffer", "aTexCoord", this, (arr)=>arr.flat())
            ],
            stroke: [
                new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$RenderBuffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RenderBuffer"](4, "lineVertexColors", "lineColorBuffer", "aVertexColor", this).default((geometry)=>geometry.lineVertices.flatMap(()=>[
                            -1,
                            -1,
                            -1,
                            -1
                        ])),
                new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$RenderBuffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RenderBuffer"](3, "lineVertices", "lineVerticesBuffer", "aPosition", this),
                new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$RenderBuffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RenderBuffer"](3, "lineTangentsIn", "lineTangentsInBuffer", "aTangentIn", this),
                new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$RenderBuffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RenderBuffer"](3, "lineTangentsOut", "lineTangentsOutBuffer", "aTangentOut", this),
                new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$RenderBuffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RenderBuffer"](1, "lineSides", "lineSidesBuffer", "aSide", this)
            ],
            text: [
                new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$RenderBuffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RenderBuffer"](3, "vertices", "vertexBuffer", "aPosition", this, this._vToNArray),
                new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$RenderBuffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RenderBuffer"](2, "uvs", "uvBuffer", "aTexCoord", this, (arr)=>arr.flat())
...
function renderer3D(p51, fn) {
    p51.Renderer3D = Renderer3D;
}
if (typeof p5 !== "undefined") {
 ...
 */ function primitives3D(p51, fn) {
   ...
   */ fn.strokeMode = function(mode) {
        if (mode === undefined) {
            return this._renderer._simpleLines ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aE"] : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aF"];
        } else if (mode === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aE"]) {
            this._renderer._simpleLines = true;
        } else if (mode === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aF"]) {
   ...
   * }
   */ fn.plane = function() {
        let width = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 50, height = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : width, detailX = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 1, detailY = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 1;
   ...
   * }
   */ fn.sphere = function() {
        let radius = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 50, detailX = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 24, detailY = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 16;
   ...
   */ fn.cylinder = function() {
        let radius = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 50, height = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : radius, detailX = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 24, detailY = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 1, bottomCap = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : true, topCap = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : true;
   ...
   * }
   */ fn.cone = function() {
        let radius = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 50, height = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : radius, detailX = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 24, detailY = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 1, cap = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : true;
        this._assert3d('cone');
   ...
   */ fn.ellipsoid = function() {
        let radiusX = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 50, radiusY = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : radiusX, radiusZ = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : radiusX, detailX = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 24, detailY = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : 16;
   ...
   *   point(0, -25);
   * }
   */ Renderer3D.prototype.point = function(x, y) {
        let z = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 0;
        this.beginShape(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["X"]);
        this.vertex(x, y, z);
        this.endShape();
        return this;
    };
    Renderer3D.prototype.triangle = function(args) {
        ...
        if (!this.geometryInHash(gid)) {
            const _triangle = function() {
                const vertices = [];
                vertices.push(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](0, 0, 0));
                vertices.push(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](1, 0, 0));
                vertices.push(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](0, 1, 0));
                this.edges = [
                    [
                        0,
                        1
            ...
            const triGeom = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$Geometry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Geometry"](1, 1, _triangle, this);
        ...
        try {
            ...
            const mult = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$Matrices$2f$Matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Matrix"]([
                x2 - x1,
                y2 - y1,
                0,
                0,
    ...
    Renderer3D.prototype.ellipse = function(args) {
        this.arc(args[0], args[1], args[2], args[3], 0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["q"], __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Q"], args[4]);
    };
    Renderer3D.prototype.arc = function() {
        for(var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++){
            args[_key] = arguments[_key];
        }
        const x = args[0];
        ...
        if (Math.abs(stop - start) >= __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["q"]) {
            shape = 'ellipse';
        ...
        if (!this.geometryInHash(gid)) {
            const _arc = function() {
                ...
                if (start.toFixed(10) !== stop.toFixed(10)) {
                    ...
                    if (mode === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["at"] || typeof mode === 'undefined') {
                        this.vertices.push(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](0.5, 0.5, 0));
                        this.uvs.push([
                            0.5,
                            0.5
                        ]);
                    ...
                    for(let i = 0; i <= detail; i++){
                        ...
                        this.vertices.push(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](_x, _y, 0));
                        this.uvs.push([
                            _x,
                            _y
                        ]);
                    ...
                    switch(mode){
                        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["at"]:
                            this.faces.push([
                                0,
                            ...
                            break;
                        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["au"]:
                            this.edges.push([
                                0,
                                1
                            ]);
                            ...
                            break;
                        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Q"]:
                            this.edges.push([
                                0,
                                1
                            ]);
            ...
            const arcGeom = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$Geometry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Geometry"](detail, 1, _arc, this);
    ...
    Renderer3D.prototype.rect = function(args) {
        ...
        if (typeof args[4] === 'undefined') {
            var _this__pInst__glAttributes;
            var _this__pInst__glAttributes_perPixelLighting;
            // Use the retained mode for drawing rectangle,
            // if args for rounding rectangle is not provided by user.
            const perPixelLighting = (_this__pInst__glAttributes_perPixelLighting = (_this__pInst__glAttributes = this._pInst._glAttributes) === null || _this__pInst__glAttributes === void 0 ? void 0 : _this__pInst__glAttributes.perPixelLighting) !== null && _this__pInst__glAttributes_perPixelLighting !== void 0 ? _this__pInst__glAttributes_perPixelLighting : true;
            const detailX = args[4] || (perPixelLighting ? 1 : 24);
            const detailY = args[5] || (perPixelLighting ? 1 : 16);
            const gid = "rect|".concat(detailX, "|").concat(detailY);
            if (!this.geometryInHash(gid)) {
                const _rect = function() {
                    for(let i = 0; i <= this.detailY; i++){
                        ...
                        for(let j = 0; j <= this.detailX; j++){
                            ...
                            const p = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](u, v, 0);
                ...
                const rectGeom = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$Geometry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Geometry"](detailX, detailY, _rect, this);
            ...
            this.states.setValue('textureMode', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a2"]);
            ...
            this.endShape(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["V"]);
            this.states.setValue('textureMode', prevMode);
            this.bezierOrder(prevOrder);
        }
        return this;
    };
    Renderer3D.prototype.quad = function(x1, y1, z1, x2, y2, z2, x3, y3, z3, x4, y4, z4) {
        let detailX = arguments.length > 12 && arguments[12] !== void 0 ? arguments[12] : 2, detailY = arguments.length > 13 && arguments[13] !== void 0 ? arguments[13] : 2;
        const gid = "quad|".concat(x1, "|").concat(y1, "|").concat(z1, "|").concat(x2, "|").concat(y2, "|").concat(z2, "|").concat(x3, "|").concat(y3, "|").concat(z3, "|").concat(x4, "|").concat(y4, "|").concat(z4, "|").concat(detailX, "|").concat(detailY);
        if (!this.geometryInHash(gid)) {
            const quadGeom = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$Geometry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Geometry"](detailX, detailY, function() {
                ...
                for(let y = 0; y < this.detailY; y++){
                    for(let x = 0; x < this.detailX; x++){
                        ...
                        this.vertices.push(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](ptx, pty, ptz));
                        this.uvs.push([
                            pctx,
                            pcty
                        ]);
   ...
   * }
   */ Renderer3D.prototype.line = function() {
        for(var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++){
            args[_key] = arguments[_key];
        }
        if (args.length === 6) {
            // TODO shapes refactor
            this.beginShape(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Y"]);
   ...
   */ const _truncatedCone = function(bottomRadius, topRadius, height, detailX, detailY, bottomCap, topCap) {
        ...
        for(yy = start; yy <= end; ++yy){
            ...
            for(ii = 0; ii < detailX; ++ii){
                ...
                //VERTICES
                this.vertices.push(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](sur * ringRadius, y, cur * ringRadius));
                //VERTEX NORMALS
                let vertexNormal;
                if (yy < 0) {
                    vertexNormal = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](0, -1, 0);
                } else if (yy > detailY && topRadius) {
                    vertexNormal = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](0, 1, 0);
                } else {
                    vertexNormal = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](sur * cosSlant, sinSlant, cur * cosSlant);
                }
    ...
    Renderer3D.prototype.plane = function() {
        let width = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 50, height = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : width, detailX = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 1, detailY = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 1;
        const gid = "plane|".concat(detailX, "|").concat(detailY);
        if (!this.geometryInHash(gid)) {
            const _plane = function() {
                ...
                for(let i = 0; i <= this.detailY; i++){
                    ...
                    for(let j = 0; j <= this.detailX; j++){
                        u = j / this.detailX;
                        p = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](u - 0.5, v - 0.5, 0);
                        this.vertices.push(p);
                        this.uvs.push(u, v);
                    }
                }
            };
            const planeGeom = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$Geometry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Geometry"](detailX, detailY, _plane, this);
    ...
    Renderer3D.prototype.box = function() {
        let width = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 50, height = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : width, depth = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : height, detailX = arguments.length > 3 ? arguments[3] : void 0, detailY = arguments.length > 4 ? arguments[4] : void 0;
        ...
        const gid = "box|".concat(detailX, "|").concat(detailY);
        if (!this.geometryInHash(gid)) {
            const _box = function() {
                const cubeIndices = [
                    [
                ...
                cubeIndices.forEach((cubeIndex, i)=>{
                    ...
                    for(let j = 0; j < 4; j++){
                        ...
                        const octant = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](((d & 1) * 2 - 1) / 2, ((d & 2) - 1) / 2, ((d & 4) / 2 - 1) / 2);
            ...
            const boxGeom = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$Geometry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Geometry"](detailX, detailY, _box, this);
    ...
    Renderer3D.prototype.ellipsoid = function() {
        let radiusX = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 50, radiusY = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : radiusX, radiusZ = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : radiusX, detailX = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 24, detailY = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : 16;
        const gid = "ellipsoid|".concat(detailX, "|").concat(detailY);
        if (!this.geometryInHash(gid)) {
            const _ellipsoid = function() {
                for(let i = 0; i <= this.detailY; i++){
                    ...
                    for(let j = 0; j <= this.detailX; j++){
                        ...
                        const p = new p51.Vector(cosPhi * sinTheta, sinPhi, cosPhi * cosTheta);
                        this.vertices.push(p);
            ...
            const ellipsoidGeom = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$Geometry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Geometry"](detailX, detailY, _ellipsoid, this);
    ...
    Renderer3D.prototype.cylinder = function() {
        let radius = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 50, height = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : radius, detailX = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 24, detailY = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 1, bottomCap = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : true, topCap = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : true;
        const gid = "cylinder|".concat(detailX, "|").concat(detailY, "|").concat(bottomCap, "|").concat(topCap);
        if (!this.geometryInHash(gid)) {
            const cylinderGeom = new p51.Geometry(detailX, detailY, function() {
    ...
    Renderer3D.prototype.cone = function() {
        let radius = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 50, height = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : radius, detailX = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 24, detailY = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 1, cap = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : true;
        const gid = "cone|".concat(detailX, "|").concat(detailY, "|").concat(cap);
        if (!this.geometryInHash(gid)) {
            const coneGeom = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$Geometry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Geometry"](detailX, detailY, function() {
    ...
    Renderer3D.prototype.torus = function() {
        let radius = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 50, tubeRadius = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 10, detailX = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 24, detailY = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 16;
        if (radius === 0) {
        ...
        const gid = "torus|".concat(tubeRatio, "|").concat(detailX, "|").concat(detailY);
        if (!this.geometryInHash(gid)) {
            const _torus = function() {
                for(let i = 0; i <= this.detailY; i++){
                    ...
                    for(let j = 0; j <= this.detailX; j++){
                        ...
                        const cosTheta = Math.cos(theta);
                        const sinTheta = Math.sin(theta);
                        const p = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](r * cosTheta, r * sinTheta, tubeRatio * sinPhi);
                        const n = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](cosPhi * cosTheta, cosPhi * sinTheta, sinPhi);
                        this.vertices.push(p);
            ...
            const torusGeom = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$Geometry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Geometry"](detailX, detailY, _torus, this);
 ...
 */ function light(p51, fn) {
   ...
   *   useFalloff = true;
   * }
   */ fn.lightFalloff = function(constantAttenuation, linearAttenuation, quadraticAttenuation) {
   ...
   * @param  {Number}                   [angle]
   * @param  {Number}                   [concentration]
   */ fn.spotLight = function(v1, v2, v3, x, y, z, nx, ny, nz, angle, concentration) {
   ...
   */ fn.noLights = function() {
    ...
    Renderer3D.prototype.ambientLight = function(v1, v2, v3, a) {
        ...
        this.states.ambientLightColors.push(color._array[0], color._array[1], color._array[2]);
    ...
    Renderer3D.prototype.directionalLight = function(v1, v2, v3, x, y, z) {
        let color;
        if (v1 instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$creating_reading$2d$C7hu6sg1$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["C"]) {
            color = v1;
        } else {
        ...
        this.states.directionalLightDiffuseColors.push(color._array[0], color._array[1], color._array[2]);
        this.states.setValue('directionalLightSpecularColors', [
            ...this.states.directionalLightSpecularColors
        ]);
    ...
    Renderer3D.prototype.pointLight = function(v1, v2, v3, x, y, z) {
        ...
        this.states.pointLightDiffuseColors.push(color._array[0], color._array[1], color._array[2]);
        this.states.setValue('pointLightSpecularColors', [
            ...this.states.pointLightSpecularColors
        ]);
    ...
    Renderer3D.prototype.spotLight = function(v1, v2, v3, x, y, z, nx, ny, nz, angle, concentration) {
        ...
        switch(length){
            ...
            case 10:
                color = this._pInst.color(v1, v2, v3);
                position = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](x, y, z);
                direction = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](nx, ny, nz);
                break;
            case 9:
                if (v1 instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$creating_reading$2d$C7hu6sg1$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["C"]) {
                    color = v1;
                    position = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](v2, v3, x);
                    direction = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](y, z, nx);
                    angle = ny;
                    concentration = nz;
                } else if (x instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"]) {
                    color = this._pInst.color(v1, v2, v3);
                    position = x;
                    direction = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](y, z, nx);
                    angle = ny;
                    concentration = nz;
                } else if (nx instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"]) {
                    color = this._pInst.color(v1, v2, v3);
                    position = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](x, y, z);
                    direction = nx;
                    angle = ny;
            ...
            case 8:
                ...
                break;
            case 7:
                if (v1 instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$creating_reading$2d$C7hu6sg1$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["C"] && v2 instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"]) {
                    color = v1;
                    position = v2;
                    direction = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](v3, x, y);
                    angle = z;
                    concentration = nx;
                } else if (v1 instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$creating_reading$2d$C7hu6sg1$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["C"] && y instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"]) {
                    color = v1;
                    position = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](v2, v3, x);
                    direction = y;
                    angle = z;
                    concentration = nx;
                } else if (x instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"] && y instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"]) {
                    color = this._pInst.color(v1, v2, v3);
                    position = x;
                    direction = y;
                    angle = z;
                    concentration = nx;
                } else if (v1 instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$creating_reading$2d$C7hu6sg1$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["C"]) {
                    color = v1;
                    position = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](v2, v3, x);
                    direction = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](y, z, nx);
                } else if (x instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"]) {
                ...
                break;
            case 6:
                if (x instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"] && y instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"]) {
                    color = this._pInst.color(v1, v2, v3);
                    position = x;
                    direction = y;
                    angle = z;
                ...
                break;
            case 5:
                if (v1 instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$creating_reading$2d$C7hu6sg1$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["C"] && v2 instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"] && v3 instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"]) {
                    color = v1;
                    position = v2;
                    direction = v3;
                    angle = x;
...
function withGlobalStrands(p51, cb) {
    const prevGlobalStrands = p51._runStrandsInGlobalMode;
    p51._runStrandsInGlobalMode = true;
    try {
        return cb();
    } finally{
        p51._runStrandsInGlobalMode = prevGlobalStrands;
    }
}
function material(p51, fn) {
    /**
   ...
   *   quad(-1, -1, 1, -1, 1, 1, -1, 1);
   * }
   */ fn.loadShader = async function(vertFilename, fragFilename, successCallback, failureCallback) {
        // p5._validateParameters('loadShader', arguments);
        const loadedShader = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$Shader$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Shader"]();
        try {
   ...
   */ fn.createShader = function(vertSrc, fragSrc, options) {
        ...
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$Shader$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Shader"](this._renderer, vertSrc, fragSrc, options);
    };
    /**
   ...
   */ fn.loadFilterShader = async function(fragFilename, successCallback, failureCallback) {
        ...
        try {
            ...
            if (/void\s+main/.exec(fragString)) {
                ...
                loadedShader = this._internal(()=>withGlobalStrands(this, ()=>this.baseFilterShader().modify(new Function(fragString))));
            }
            if (successCallback) {
   ...
   */ fn.createFilterShader = function(fragSrc) {
        let skipContextCheck = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
        ...
        const shader = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$Shader$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Shader"](this._renderer, vertSrc, fragSrc);
        if (!skipContextCheck) {
   ...
   */ fn.loadNormalShader = async function(url, onSuccess, onFail) {
        try {
            const cb = await urlToStrandsCallback(url);
            let shader = this._internal(()=>this.withGlobalStrands(this, ()=>this.buildNormalShader(cb)));
            if (onSuccess) {
                shader = onSuccess(shader) || shader;
            }
            return shader;
   ...
   */ fn.textureMode = function(mode) {
        if (mode !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ad"] && mode !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a2"]) {
   ...
   *   endShape();
   * }
   */ fn.textureWrap = function(wrapX) {
        let wrapY = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : wrapX;
   ...
   */ fn.ambientMaterial = function(v1, v2, v3) {
        ...
        if (!this._renderer.states.fillColor) {
            this._renderer.states.setValue("fillColor", new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$creating_reading$2d$C7hu6sg1$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["C"]([
                1,
                1,
                1
            ]));
   ...
   */ fn.metalness = function(metallic) {
    ...
    Renderer3D.prototype.texture = function(tex) {
        this.states.setValue("drawMode", __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["h"]);
        this.states.setValue("_useNormalMaterial", false);
        this.states.setValue("_tex", tex);
        this.states.setValue("fillColor", new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$creating_reading$2d$C7hu6sg1$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["C"]([
            1,
            1,
            1
        ]));
    };
    Renderer3D.prototype.normalMaterial = function() {
        for(var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++){
            args[_key] = arguments[_key];
        }
        this.states.setValue("drawMode", __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aD"]);
 ...
 */ class Graphics {
    ...
    get canvas() {
        var _this__renderer;
        return (_this__renderer = this._renderer) === null || _this__renderer === void 0 ? void 0 : _this__renderer.canvas;
    }
    get drawingContext() {
    ...
    get width() {
        var _this__renderer;
        return (_this__renderer = this._renderer) === null || _this__renderer === void 0 ? void 0 : _this__renderer.width;
    }
    get height() {
        var _this__renderer;
        return (_this__renderer = this._renderer) === null || _this__renderer === void 0 ? void 0 : _this__renderer.height;
    }
    get pixels() {
        var _this__renderer;
   ...
   */ createFramebuffer(options) {
    ...
    constructor(w, h, renderer, pInst, canvas){
        const r = renderer || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["P"];
        this._pInst = pInst;
...
function graphics(p51, fn) {
   ...
   *   }
   * }
   */ p51.Graphics = Graphics;
    // Shapes
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$shape$2f$2d_primitives$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(p51, p51.Graphics.prototype);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$shape$2f$attributes$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(p51, p51.Graphics.prototype);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$shape$2f$curves$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(p51, p51.Graphics.prototype);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$shape$2f$vertex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(p51, p51.Graphics.prototype);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$shape$2f$custom_shapes$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(p51, p51.Graphics.prototype);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$color$2f$setting$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(p51, p51.Graphics.prototype);
    loadingDisplaying(p51, p51.Graphics.prototype);
    image(p51, p51.Graphics.prototype);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$image$2f$pixels$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(p51, p51.Graphics.prototype);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$core$2f$transform$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(p51, p51.Graphics.prototype);
    primitives3D(p51, p51.Graphics.prototype);
    light(p51, p51.Graphics.prototype);
    material(p51, p51.Graphics.prototype);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$creating_reading$2d$C7hu6sg1$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(p51, p51.Graphics.prototype);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$math$2f$trigonometry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(p51, p51.Graphics.prototype);
}
/**
 ...
 */ class Texture {
    ...
    if (
      ...
      if (this.glMagFilter === gl.LINEAR) this.glMagFilter = gl.NEAREST;
        ...
        this.isSrcP5Image = obj instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["I"];
        this.isSrcP5Graphics = obj instanceof Graphics;
        this.isSrcP5Renderer = obj instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$BmD2P6Wv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"];
        this.isImageData = typeof ImageData !== 'undefined' && obj instanceof ImageData;
        this.isSrcMediaElement = typeof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$MediaElement$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MediaElement"] !== 'undefined' && obj instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$MediaElement$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MediaElement"];
        this.isSrcHTMLElement = typeof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$Element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Element"] !== 'undefined' && obj instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$Element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Element"] && !this.isSrcMediaElement && !this.isSrcP5Graphics && !this.isSrcP5Renderer;
    }
    remove() {
   ...
   */ init(textureData) {
        ...
        if (this._shouldDeferUpload()) {
            this._renderer.uploadTextureFromData(this.textureHandle, new Uint8Array(1, 1, 1, 1), 1, 1);
   ...
   */ update() {
    ...
    constructor(renderer, obj, settings = {}){
        ...
        this.minFilter = settings.minFilter || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"];
        this.magFilter = settings.magFilter || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"];
...
class MipmapTexture extends Texture {
    ...
    constructor(renderer, levels, settings = {}){
        ...
        const mipmapSettings = {
            minFilter: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"],
            magFilter: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"],
            ...settings
        };
...
function texture(p51, fn) {
   ...
   */ p51.Texture = Texture;
    p51.MipmapTexture = MipmapTexture;
}
if (typeof p5 !== 'undefined') {
...
function setWebGLTextureParams(texture, gl, webglVersion) {
    texture.bindTexture();
    const glMinFilter = texture.minFilter === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["N"] ? gl.NEAREST : texture.minFilter === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aG"] ? gl.LINEAR_MIPMAP_LINEAR : gl.LINEAR;
    const glMagFilter = texture.magFilter === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["N"] ? gl.NEAREST : gl.LINEAR;
    ...
    let glWrapS, glWrapT;
    if (texture.wrapS === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["f"]) {
        if (webglVersion === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aa"] || widthPowerOfTwo && heightPowerOfTwo) {
            glWrapS = gl.REPEAT;
        } else {
    ...
    } else if (texture.wrapS === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["e"]) {
        if (webglVersion === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aa"] || widthPowerOfTwo && heightPowerOfTwo) {
    ...
    if (texture.wrapT === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["f"]) {
        if (webglVersion === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aa"] || widthPowerOfTwo && heightPowerOfTwo) {
            glWrapT = gl.REPEAT;
        } else {
            console.warn("You tried to set the wrap mode to REPEAT but the texture size is not a power of two. Setting to CLAMP instead");
    ...
    } else if (texture.wrapT === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["e"]) {
        if (webglVersion === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aa"] || widthPowerOfTwo && heightPowerOfTwo) {
...
function getWebGLShaderAttributes(shader, gl) {
    const attributes = {};
    const numAttributes = gl.getProgramParameter(shader._glProgram, gl.ACTIVE_ATTRIBUTES);
...
function populateGLSLHooks(shader, src, shaderType) {
    ...
    if (shader.hooks.varyingVariables && shader.hooks.varyingVariables.length > 0) {
        for (const varyingVar of shader.hooks.varyingVariables){
            ...
            if (shaderType === "vertex") {
                hooks += "OUT ".concat(varyingVar, ";\n");
            } else if (shaderType === "fragment") {
                hooks += "IN ".concat(varyingVar, ";\n");
            }
        }
    }
    for(const hookDef in shader.hooks.helpers){
        hooks += "".concat(hookDef).concat(shader.hooks.helpers[hookDef], "\n");
    }
    for(const hookDef in shader.hooks[shaderType]){
        ...
        if (shader.hooks.modified.vertex[hookDef] || shader.hooks.modified.fragment[hookDef]) {
...
function checkWebGLCapabilities(param) {
    let { GL, webglVersion } = param;
    const gl = GL;
    const supportsFloat = webglVersion === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aa"] ? gl.getExtension("EXT_color_buffer_float") && gl.getExtension("EXT_float_blend") : gl.getExtension("OES_texture_float");
    const supportsFloatLinear = supportsFloat && gl.getExtension("OES_texture_float_linear");
    const supportsHalfFloat = webglVersion === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aa"] ? gl.getExtension("EXT_color_buffer_float") : gl.getExtension("OES_texture_half_float");
...
class Framebuffer {
   ...
   */ _checkIfFormatsAvailable() {
        const gl = this.gl;
        if (this.useDepth && this.renderer.webglVersion === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ac"] && !gl.getExtension('WEBGL_depth_texture')) {
            console.warn('Unable to create depth textures in this environment. Falling back ' + 'to a framebuffer without depth.');
            this.useDepth = false;
        }
        if (this.useDepth && this.renderer.webglVersion === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ac"] && this.depthFormat === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["F"]) {
            console.warn('FLOAT depth format is unavailable in WebGL 1. ' + 'Defaulting to UNSIGNED_INT.');
            this.depthFormat = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["d"];
        }
        if (![
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["U"],
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["F"],
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["H"]
        ].includes(this.format)) {
            console.warn('Unknown Framebuffer format. ' + 'Please use UNSIGNED_BYTE, FLOAT, or HALF_FLOAT. ' + 'Defaulting to UNSIGNED_BYTE.');
            this.format = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["U"];
        }
        if (this.useDepth && ![
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["d"],
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["F"]
            ...
            this.depthFormat = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["F"];
        }
        const support = checkWebGLCapabilities(this.renderer);
        if (!support.float && this.format === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["F"]) {
            console.warn('This environment does not support FLOAT textures. ' + 'Falling back to UNSIGNED_BYTE.');
            this.format = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["U"];
        }
        if (this.useDepth && !support.float && this.depthFormat === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["F"]) {
            console.warn('This environment does not support FLOAT depth textures. ' + 'Falling back to UNSIGNED_INT.');
            this.depthFormat = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["d"];
        }
        if (!support.halfFloat && this.format === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["H"]) {
            console.warn('This environment does not support HALF_FLOAT textures. ' + 'Falling back to UNSIGNED_BYTE.');
            this.format = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["U"];
        }
        if (this.channels === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$creating_reading$2d$C7hu6sg1$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"] && [
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["F"],
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["H"]
        ].includes(this.format)) {
            console.warn('FLOAT and HALF_FLOAT formats do not work cross-platform with only ' + 'RGB channels. Falling back to RGBA.');
            this.channels = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$creating_reading$2d$C7hu6sg1$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["h"];
        }
    }
    _deleteTextures() {
   ...
   */ _recreateTextures() {
        ...
        if (this.useDepth) {
            ...
            const depthFilter = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["N"];
        ...
        const filter = this.textureFiltering === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"] ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"] : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["N"];
   ...
   */ updatePixels() {
    ...
    constructor(renderer, settings = {}){
        ...
        this.pixels = [];
        this.format = settings.format || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["U"];
        this.channels = settings.channels || (this.renderer.defaultFramebufferAlpha() ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$creating_reading$2d$C7hu6sg1$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["h"] : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$creating_reading$2d$C7hu6sg1$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"]);
        this.useDepth = settings.depth === undefined ? true : settings.depth;
        this.depthFormat = settings.depthFormat || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["F"];
        this.textureFiltering = settings.textureFiltering || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"];
...
function framebuffer(p51, fn) {
   ...
   * attached to
   * @private
   */ p51.FramebufferCamera = FramebufferCamera;
    /**
   ...
   * @private
   */ p51.FramebufferTexture = FramebufferTexture;
    /**
...
function rendering(p51, fn) {
   ...
   * @return {p5.Renderer}
   */ fn.createCanvas = function(w, h, renderer) {
        for(var _len = arguments.length, args = new Array(_len > 3 ? _len - 3 : 0), _key = 3; _key < _len; _key++){
            args[_key - 3] = arguments[_key];
        }
        // p5._validateParameters('createCanvas', arguments);
        //optional: renderer, otherwise defaults to p2d
        let selectedRenderer = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["P"];
   ...
   */ fn.createGraphics = function(w, h) {
     ...
     */ if (args[0] instanceof HTMLCanvasElement) {
            args[1] = args[0];
            args[0] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$BdTiYOQI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["P"];
        }
        // p5._validateParameters('createGraphics', arguments);
        return new p51.Graphics(w, h, args[0], this, args[1]);
    };
    /**
...
//# sourceMappingURL=node_modules_p5_dist_rendering-CC8JNTwG_822cd434.js.map