...
var ia = Object.getPrototypeOf, na = Object.prototype.hasOwnProperty;
var mt = function(r, e) {
    return function() {
        return r && (e = r(r = 0)), e;
    };
...
var oa = function(r, e, t, i) {
    if (e && typeof e == "object" || typeof e == "function") for(var a = aa(e), n = 0, o = a.length, s; n < o; n++)s = a[n], !na.call(r, s) && s !== t && pt(r, s, {
        get: (function(u) {
            return e[u];
        }).bind(null, s),
...
var G = function(r, e, t) {
    return t = r != null ? ta(ia(r)) : {}, oa(e || !r || !r.__esModule ? pt(t, "default", {
        value: r,
        enumerable: !0
    }) : t, r);
};
var Q = B(function(tn, gt) {
    var De;
    ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : ("TURBOPACK compile-time truthy", 1) ? De = /*TURBOPACK member replacement*/ __turbopack_context__.g : "TURBOPACK unreachable";
    gt.exports = De;
});
function U(r, e) {
...
var cr = B(function(Ps, dr) {
    ...
    dr.exports = ye;
    function ye(r, e) {
        if (!U(this, ye)) return new ye(r, e);
...
var it = B(function(Fs, Tr) {
    ae();
    var at = $e(), Qa = Ze(), za = et(), Ka = tt(), Ya = br(), wr = "http://www.w3.org/1999/xhtml";
    Tr.exports = I;
    function I(r, e, t) {
...
var kr = B(function(js, Er) {
    ae();
    var nt = it();
    Er.exports = Y;
    function Y(r) {
        if (!U(this, Y)) return new Y;
...
var Sr = B(function(Js, Dr) {
    ae();
    var Xa = $e(), $a = cr(), Za = fr(), Ae = it(), ei = kr(), ti = Rr(), ri = Ze(), ai = et(), ii = tt();
    Dr.exports = We;
    function We() {
        if (!U(this, We)) return new We;
...
var st = B(function(zs, Pr) {
    var Or = ("TURBOPACK compile-time truthy", 1) ? /*TURBOPACK member replacement*/ __turbopack_context__.g : "TURBOPACK unreachable", oi = Ar(), Oe;
...
function Le(r, e) {
    if (r) {
        if (typeof r == "string") return Re(r, e);
        var t = Object.prototype.toString.call(r).slice(8, -1);
        if (t === "Object" && r.constructor && (t = r.constructor.name), t === "Map" || t === "Set") return Array.from(t);
        if (t === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t)) return Re(r, e);
    }
}
function H(r, e) {
    return vt(r) || ht(r, e) || Le(r, e) || yt();
}
var Te = G(Q());
var ze = G(Q());
var bt = G(Q()), sa = {
    now: function() {
        var r = bt.default.performance, e = r && r.timing, t = e && e.navigationStart, i = typeof t == "number" && typeof r.now == "function" ? t + r.now() : Date.now();
        return Math.round(i);
    }
}, O = sa;
var re = function() {
    ...
    if (typeof ((e = ze.default.crypto) === null || e === void 0 ? void 0 : e.getRandomValues) == "function") {
        i = new Uint8Array(32), ze.default.crypto.getRandomValues(i);
    ...
    var s = O.now(), u = s == null ? void 0 : s.toString(16).substring(3);
...
function wt(r) {
    if (Array.isArray(r)) return Re(r);
}
function Tt(r) {
...
var X = {
    ...
    var e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 3, t, i, a, n, o, s = r ? [
        ...
        console
    ], u = (t = console.trace).bind.apply(t, W(s)), p = (i = console.info).bind.apply(i, W(s)), y = (a = console.debug).bind.apply(a, W(s)), x = (n = console.warn).bind.apply(n, W(s)), D = (o = console.error).bind.apply(o, W(s)), f = e;
    return {
        trace: function() {
            for(var v = arguments.length, w = new Array(v), h = 0; h < v; h++)w[h] = arguments[h];
            if (!(f > X.TRACE)) return u.apply(void 0, W(w));
        },
        debug: function() {
            for(var v = arguments.length, w = new Array(v), h = 0; h < v; h++)w[h] = arguments[h];
            if (!(f > X.DEBUG)) return y.apply(void 0, W(w));
        },
        info: function() {
            for(var v = arguments.length, w = new Array(v), h = 0; h < v; h++)w[h] = arguments[h];
            if (!(f > X.INFO)) return p.apply(void 0, W(w));
        },
        warn: function() {
            for(var v = arguments.length, w = new Array(v), h = 0; h < v; h++)w[h] = arguments[h];
            if (!(f > X.WARN)) return x.apply(void 0, W(w));
        },
        error: function() {
            for(var v = arguments.length, w = new Array(v), h = 0; h < v; h++)w[h] = arguments[h];
            if (!(f > X.ERROR)) return D.apply(void 0, W(w));
        },
        get level () {
            return f;
        },
...
var Ne = G(Q());
function fe() {
    var r = Ne.default.doNotTrack || Ne.default.navigator && Ne.default.navigator.doNotTrack;
    return r === "1";
}
function b(r) {
...
function N(r, e, t) {
    return e && xt(r.prototype, e), t && xt(r, t), r;
}
function l(r, e, t) {
...
function Rt(r, e) {
    for(; !Object.prototype.hasOwnProperty.call(r, e) && (r = $(r), r !== null););
    return r;
}
function Se(r, e, t) {
...
function Ce(r, e) {
    return Ce = Object.setPrototypeOf || function(i, a) {
...
Ke();
function Ot(r, e) {
    return e && (Me(e) === "object" || typeof e == "function") ? e : b(r);
}
function Pt(r) {
    var e = At();
    return function() {
...
var He = G(Q()), ua = {
    exists: function() {
        var r = He.default.performance, e = r && r.timing;
        return e !== void 0;
    },
...
function me(r, e) {
    return e = e != null ? e : {}, Object.getOwnPropertyDescriptors ? Object.defineProperties(r, Object.getOwnPropertyDescriptors(e)) : la(Object(e)).forEach(function(t) {
...
function ve(r) {
    ...
    return t.forEach(function(i) {
        if (i) {
            ...
            n && (ca.indexOf(n.toLowerCase()) >= 0 || n.toLowerCase().indexOf("x-litix-") === 0) && (e[n] = a.join(": "));
        }
    }), e;
}
function ce(r) {
    if (r) {
        var e = Lt.find(function(t) {
            return r[t] !== void 0;
        });
        return e ? r[e] : void 0;
    }
...
var Ue = function(r) {
    if (!r) return {};
    var e = pe.navigationStart(), t = r.loading, i = t ? t.start : r.trequest, a = t ? t.first : r.tfirst, n = t ? t.end : r.tload;
    return {
        bytesLoaded: r.total,
    ...
    if (!(!r || typeof r.getAllResponseHeaders != "function")) return ve(r.getAllResponseHeaders());
}, It = function(r, e, t) {
    var i = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {}, a = arguments.length > 4 ? arguments[4] : void 0, n = r.log, o = r.utils.secondsToMs, s = function(h) {
    ...
    var u = function(h, m) {
        ...
        var A = Ue(T), R = A.bytesLoaded, te = A.requestStart, Ee = A.responseStart, ke = A.responseEnd;
        u("requestcompleted", me(Z({}, Be(S)), {
    ...
    var y = function(h, m) {
        var c = m.details, d = m.level, g = m.networkDetails, T = m.stats, E = Ue(T), S = E.bytesLoaded, L = E.requestStart, C = E.responseStart, A = E.responseEnd, R = c.fragments[c.fragments.length - 1], te = s(R) + o(R.duration);
        u("requestcompleted", {
            request_event_type: h,
            ...
            request_type: "manifest",
            request_hostname: F(c.url),
            request_response_headers: qe(g),
    ...
    var x = function(h, m) {
        var c = m.details, d = m.networkDetails, g = m.stats, T = Ue(g), E = T.bytesLoaded, S = T.requestStart, L = T.responseStart, C = T.responseEnd;
        u("requestcompleted", {
            request_event_type: h,
    ...
    var D = function(h, m) {
        ...
        c = c || g.stats;
        var T = Ue(c), E = T.bytesLoaded, S = T.requestStart, L = T.responseStart, C = T.responseEnd, A = d ? qe(d) : void 0, R = {
            request_event_type: h,
            request_bytes_loaded: E,
            request_start: S,
            request_response_start: L,
    ...
    var f = function(h, m) {
        var c = m.frag, d = c.start, g = s(c), T = {
    ...
    var _1 = function(h, m) {
        var c = m.type, d = m.details, g = m.response, T = m.fatal, E = m.frag, S = m.networkDetails, L = (E == null ? void 0 : E.url) || m.url || "", C = S ? qe(S) : void 0;
    ...
    t.on(a.Events.LEVEL_SWITCHED, w), t._stopMuxMonitor = function() {
        t.off(a.Events.MANIFEST_LOADED, p), t.off(a.Events.LEVEL_LOADED, y), t.off(a.Events.AUDIO_TRACK_LOADED, x), t.off(a.Events.FRAG_LOADED, D), t.off(a.Events.FRAG_CHANGED, f), t.off(a.Events.ERROR, _1), t.off(a.Events.FRAG_LOAD_EMERGENCY_ABORTED, v), t.off(a.Events.LEVEL_SWITCHED, w), t.off(a.Events.DESTROYING, t._stopMuxMonitor), delete t._stopMuxMonitor;
...
var Ct = function(r, e) {
    ...
    var t = F(r.url), i = r.url, a = r.bytesLoaded, n = new Date(r.requestStartDate).getTime(), o = new Date(r.firstByteDate).getTime(), s = new Date(r.requestEndDate).getTime(), u = isNaN(r.duration) ? 0 : r.duration, p = typeof e.getMetricsFor == "function" ? e.getMetricsFor(r.mediaType).HttpList : e.getDashMetrics().getHttpRequests(r.mediaType), y;
    p.length > 0 && (y = ve(p[p.length - 1]._responseHeaders || ""));
    var x = y ? ce(y) : void 0;
    return {
        requestStart: n,
    ...
    var n = ma(t), o = function(c, d) {
        return r.emit(e, c, d);
    }, s = function(c) {
        var d = c.type, g = c.data, T = (g || {}).url;
        o("requestcompleted", {
    ...
    var u = {}, p = function(c) {
        ...
        var d = c.type, g = c.fragmentModel, T = c.chunk, E = p(g);
        x({
            type: d,
            request: E,
            chunk: T
        ...
        var d = c.type, g = c.chunk, T = c.request, E = (g || {}).mediaInfo, S = E || {}, L = S.type, C = S.bitrateList;
        C = C || [];
        var A = {};
        ...
        var R = Ct(T, t), te = R.requestStart, Ee = R.requestResponseStart, ke = R.requestResponseEnd, V = R.requestResponseHeaders, le = R.requestMediaDuration, Ge = R.requestHostname, Je = R.requestUrl, Qe = R.requestId;
        o("requestcompleted", {
            request_event_type: d,
            request_start: te,
            request_response_start: Ee,
    ...
    var _1 = {
        ...
        if (_1.video && typeof _1.video.bitrate == "number") {
            if (!(_1.video.width && _1.video.height)) {
                a.warn("have bitrate info for video but missing width/height");
                return;
            }
            var c = _1.video.bitrate;
            if (_1.audio && typeof _1.audio.bitrate == "number" && (c += _1.audio.bitrate), c !== _1.totalBitrate) return _1.totalBitrate = c, {
                video_source_bitrate: c,
                video_source_height: _1.video.height,
                video_source_width: _1.video.width,
                video_source_codec: pa(_1.video.codec)
            };
        }
    }, w = function(c, d, g) {
        var T = c.mediaType;
...
var Bt = 0, va = function() {
    "use strict";
    function r() {
        k(this, r), l(this, "_listeners", void 0);
    }
    return N(r, [
        {
            key: "on",
            value: function(t, i, a) {
                return i._eventEmitterGuid = i._eventEmitterGuid || ++Bt, this._listeners = this._listeners || {}, this._listeners[t] = this._listeners[t] || [], a && (i = i.bind(a)), this._listeners[t].push(i), i;
            }
        },
        {
            key: "off",
        ...
        },
        {
            ...
            value: function(t, i, a) {
                var n = this;
                i._eventEmitterGuid = i._eventEmitterGuid || ++Bt;
                var o = function() {
...
var Fe = G(Q()), ha = function() {
    "use strict";
    function r(e) {
        var t = this;
        k(this, r), l(this, "_playbackHeartbeatInterval", void 0), l(this, "_playheadShouldBeProgressing", void 0), l(this, "pm", void 0), this.pm = e, this._playbackHeartbeatInterval = null, this._playheadShouldBeProgressing = !1, e.on("playing", function() {
            ...
            t._playbackHeartbeatInterval !== null && (Fe.default.clearInterval(t._playbackHeartbeatInterval), e.emit("playbackheartbeatend", {
    ...
    return N(r, [
        ...
        },
        {
            ...
            value: function() {
                this._playheadShouldBeProgressing = !1, this._playbackHeartbeatInterval !== null && (Fe.default.clearInterval(this._playbackHeartbeatInterval), this.pm.emit("playbackheartbeatend"), this._playbackHeartbeatInterval = null);
            }
        }
    ]), r;
}(), Ft = ha;
...
var ga = function() {
    "use strict";
    function r(e) {
        k(this, r), l(this, "_watchTimeTrackerLastCheckedTime", void 0), l(this, "pm", void 0), this.pm = e, this._watchTimeTrackerLastCheckedTime = null, e.on("playbackheartbeat", this._updateWatchTime.bind(this)), e.on("playbackheartbeatend", this._clearWatchTimeState.bind(this));
    }
    return N(r, [
        {
...
var ba = function() {
    ...
    function r(e) {
        var t = this;
        k(this, r), l(this, "_playbackTimeTrackerLastPlayheadPosition", void 0), l(this, "_lastTime", void 0), l(this, "_isAdPlaying", void 0), l(this, "_callbackUpdatePlaybackTime", void 0), l(this, "pm", void 0), this.pm = e, this._playbackTimeTrackerLastPlayheadPosition = -1, this._lastTime = O.now(), this._isAdPlaying = !1, this._callbackUpdatePlaybackTime = null, e.on("viewinit", function() {
        ...
        e.on("playbackheartbeatend", n), e.on("seeking", n), e.on("rebufferstart", n), e.on("adplaying", function() {
            ...
            t._playbackTimeTrackerLastPlayheadPosition = -1, t._lastTime = O.now(), t._isAdPlaying = !1, t._callbackUpdatePlaybackTime = null;
        });
    }
    return N(r, [
        {
        ...
        },
        {
            ...
            value: function() {
                var t = this.pm.data.player_playhead_time || 0, i = O.now(), a = i - this._lastTime, n = -1;
...
var wa = function() {
    "use strict";
    function r(e) {
        k(this, r), l(this, "pm", void 0), this.pm = e;
...
var Jt = 5 * 60 * 1e3, Ta = function r(e) {
    "use strict";
    if (k(this, r), !e.disableRebufferTracking) {
        var t, i = function(n, o) {
            a(o), t = void 0;
        }, a = function(n) {
            if (t) {
                var o = n.viewer_time - t;
                P(e.data, "view_rebuffer_duration", o), t = n.viewer_time, e.data.view_rebuffer_duration > Jt && (e.emit("viewend"), e.send("viewend"), e.mux.log.warn("Ending view after rebuffering for longer than ".concat(Jt, "ms, future events will be ignored unless a programchange or videochange occurs.")));
            }
...
var Ea = function() {
    ...
    function r(e) {
        var t = this;
        k(this, r), l(this, "_lastCheckedTime", void 0), l(this, "_lastPlayheadTime", void 0), l(this, "_lastPlayheadTimeUpdatedTime", void 0), l(this, "_rebuffering", void 0), l(this, "pm", void 0), this.pm = e, !(e.disableRebufferTracking || e.disablePlayheadRebufferTracking) && (this._lastCheckedTime = null, this._lastPlayheadTime = null, this._lastPlayheadTimeUpdatedTime = null, e.on("playbackheartbeat", this._checkIfRebuffering.bind(this)), e.on("playbackheartbeatend", this._cleanupRebufferTracker.bind(this)), e.on("seeking", function() {
...
var ka = function() {
    ...
    function r(e) {
        var t = this;
        k(this, r), l(this, "pm", void 0), this.pm = e, e.on("viewinit", function() {
            var i = e.data, a = i.view_id;
            if (!i.view_program_changed) {
                var n = function(o, s) {
                    var u = s.viewer_time;
                    o.type === "playing" && typeof e.data.view_time_to_first_frame == "undefined" ? t.calculateTimeToFirstFrame(u || O.now(), a) : o.type === "adplaying" && (typeof e.data.view_time_to_first_frame == "undefined" || t._inPrerollPosition()) && t.calculateTimeToFirstFrame(u || O.now(), a);
                };
...
var xa = function r(e) {
    "use strict";
    var t = this;
    k(this, r), l(this, "_lastPlayerHeight", void 0), l(this, "_lastPlayerWidth", void 0), l(this, "_lastPlayheadPosition", void 0), l(this, "_lastSourceHeight", void 0), l(this, "_lastSourceWidth", void 0), e.on("viewinit", function() {
    ...
    i.forEach(function(n) {
        e.on(n, function() {
            if (t._lastPlayheadPosition >= 0 && e.data.player_playhead_time >= 0 && t._lastPlayerWidth >= 0 && t._lastSourceWidth > 0 && t._lastPlayerHeight >= 0 && t._lastSourceHeight > 0) {
                ...
                e.data.view_max_upscale_percentage = Math.max(e.data.view_max_upscale_percentage || 0, u), e.data.view_max_downscale_percentage = Math.max(e.data.view_max_downscale_percentage || 0, p), P(e.data, "view_total_content_playback_time", o), P(e.data, "view_total_upscaling", u * o), P(e.data, "view_total_downscaling", p * o);
            }
            t._lastPlayheadPosition = -1;
        });
...
var Ra = 2e3, Da = function r(e) {
    "use strict";
    var t = this;
    k(this, r), l(this, "isSeeking", void 0), this.isSeeking = !1;
    var i = -1, a = function() {
        var n = O.now(), o = (e.data.viewer_time || n) - (i || n);
...
var $t = function(e, t) {
    ...
    function r(e) {
        ...
        e.on("adbreakstart", function() {
            ...
            }, n), $t(t._adRequests, n), P(e.data, "view_ad_request_count"), t.inPrerollPosition() && (e.data.view_preroll_requested = !0, t._adHasPlayed || P(e.data, "view_preroll_request_count"));
        }), e.on("adresponse", function(a, n) {
            n = Object.assign({
                ad_request_id: "generatedAdRequestId" + t._currentAdResponseNumber++
            }, n), $t(t._adResponses, n);
            ...
            value: function(t, i) {
                if (this.inPrerollPosition()) {
                    if (!this.pm.data.view_preroll_ad_tag_hostname && i.ad_tag_url) {
                        var a = H(ie(i.ad_tag_url), 2), n = a[0], o = a[1];
                    ...
                    if (!this.pm.data.view_preroll_ad_asset_hostname && i.ad_asset_url) {
                        var s = H(ie(i.ad_asset_url), 2), u = s[0], p = s[1];
...
var Aa = function r(e) {
    "use strict";
    var t = this;
    k(this, r), l(this, "lastWallClockTime", void 0);
    var i = function() {
        t.lastWallClockTime = O.now(), e.on("before*", a);
    }, a = function(n) {
        var o = O.now(), s = t.lastWallClockTime;
        ...
        function i(a, n, o) {
            ...
            if (typeof document != "undefined") {
                ...
                for(var p = document.cookie ? document.cookie.split("; ") : [], y = /(%[0-9A-Z]{2})+/g, x = 0; x < p.length; x++){
                    ...
                    try {
                        var _1 = D[0].replace(y, decodeURIComponent);
                        if (f = t.read ? t.read(f, _1) : t(f, _1) || f.replace(y, decodeURIComponent), this.json) try {
                            f = JSON.parse(f);
                        } catch (v) {}
                        if (a === _1) {
                            s = f;
...
var tr = "muxData", Oa = function(r) {
    ...
    var e = rr();
    return e.mux_viewer_id = e.mux_viewer_id || re(), e.msn = e.msn || Math.random(), ar(e), {
        mux_viewer_id: e.mux_viewer_id,
        mux_sample_number: e.msn
    };
}, nr = function() {
    var e = rr(), t = O.now();
    return e.session_start && (e.sst = e.session_start, delete e.session_start), e.session_id && (e.sid = e.session_id, delete e.session_id), e.session_expires && (e.sex = e.session_expires, delete e.session_expires), (!e.sex || e.sex < t) && (e.sid = re(), e.sst = t), e.sex = t + 25 * 60 * 1e3, ar(e), {
        session_id: e.sid,
        session_start: e.sst,
...
function Xe(r, e) {
    ...
    if (t) {
        var a = /localhost(?::\d+)?$/.test(t) ? "http://" : "https://";
        return a + t;
    }
    r = r || "inferred";
    var n = i || "litix.io";
...
function he(r) {
    ...
    return Object.keys(r).forEach(function(i) {
        ...
        if (r.hasOwnProperty(i) && r[i] !== void 0) {
            var n = i.split("_"), o = n[0], s = Ia[o];
            s || (q.info("Data key word `" + n[0] + "` not expected in " + i), s = o + "_"), n.splice(1).forEach(function(u) {
                u === "url" && (a = !0), or[u] ? s += or[u] : Number.isInteger(Number(u)) ? s += u : (q.info("Data key word `" + u + "` not expected in " + i), s += "_" + u + "_");
            }), a ? t[s] = r[i] : e[s] = r[i];
        }
    }), Object.assign(e, t);
}
...
var si = {
    ...
    "requestfailed",
    "requestcanceled"
], di = "https://img.litix.io", ee = function(e) {
...
ee.prototype.queueEvent = function(r, e) {
...
ee.prototype.destroy = function() {
    var r = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !1;
    this.destroyed = !0, r ? this._clearBeaconQueue() : this.flushEvents(), oe.default.clearTimeout(this._sendTimeout);
};
ee.prototype._clearBeaconQueue = function() {
    ...
    r > 0 && Object.assign(e[e.length - 1], he({
...
ee.prototype._sendBeaconQueue = function() {
    ...
    var t = this._createPayload(e), i = O.now();
    Ir(this._beaconUrl, t, !1, function(a, n) {
        n ? (r._eventQueue = e.concat(r._eventQueue), r._failureCount += 1, q.info("Error sending beacon: " + n)) : r._failureCount = 0, r._roundTripTime = O.now() - i, r._postInFlight = !1, r._resendAfterPost && (r._resendAfterPost = !1, r._eventQueue.length > 0 && r._sendBeaconQueue());
    });
};
...
ee.prototype._createPayload = function(r) {
    var e = this, t = {
        transmission_timestamp: Math.round(O.now())
    };
...
var ci = typeof Lr.default.exitPictureInPicture == "function" ? function(r) {
    ...
    if (oe.default.XMLHttpRequest) {
        var a = new oe.default.XMLHttpRequest;
...
var _i = [
    ...
    "ended",
    "viewend"
], vi = 10 * 60 * 1e3, Cr = function() {
    "use strict";
    function r(e, t) {
        var i = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
        k(this, r);
        var a, n, o, s, u, p, y, x, D, f, _1, v;
        l(this, "mux", void 0), l(this, "envKey", void 0), l(this, "options", void 0), l(this, "eventQueue", void 0), l(this, "sampleRate", void 0), l(this, "disableCookies", void 0), l(this, "respectDoNotTrack", void 0), l(this, "previousBeaconData", void 0), l(this, "lastEventTime", void 0), l(this, "rateLimited", void 0), l(this, "pageLevelData", void 0), l(this, "viewerData", void 0), this.mux = e, this.envKey = t, this.options = i, this.previousBeaconData = null, this.lastEventTime = 0, this.rateLimited = !1, this.eventQueue = new Nr(Xe(this.envKey, this.options));
        var w;
        ...
        this.respectDoNotTrack = (m = this.options.respectDoNotTrack) !== null && m !== void 0 ? m : !1, this.previousBeaconData = null, this.lastEventTime = 0, this.rateLimited = !1, this.pageLevelData = {
            ...
            viewer_os_version: (_1 = this.options.platform) === null || _1 === void 0 || (f = _1.os) === null || f === void 0 ? void 0 : f.version,
            page_url: je.default === null || je.default === void 0 || (v = je.default.location) === null || v === void 0 ? void 0 : v.href
    ...
    return N(r, [
        {
            ...
            value: function(t, i) {
                if (!(!t || !(i != null && i.view_id))) {
                    if (this.respectDoNotTrack && fe()) return q.info("Not sending `" + t + "` because Do Not Track is enabled");
                    if (!i || typeof i != "object") return q.error("A data object was expected in send() but was not provided");
                    var a = this.disableCookies ? {} : nr(), n = me(Z({}, this.pageLevelData, i, a, this.viewerData), {
                        event: t,
                        env_key: this.envKey
                    });
                    n.user_id && (n.viewer_user_id = n.user_id, delete n.user_id);
                    var o, s = ((o = n.mux_sample_number) !== null && o !== void 0 ? o : 0) >= this.sampleRate, u = this._deduplicateBeaconData(t, n), p = he(u);
                    if (this.lastEventTime = this.mux.utils.now(), s) return q.info("Not sending event due to sample rate restriction", t, n, p);
                    if (this.envKey || q.info("Missing environment key (envKey) - beacons will be dropped if the video source is not a valid mux video URL", t, n, p), !this.rateLimited) if (q.info("Sending event", t, n, p), this.rateLimited = !this.eventQueue.queueEvent(t, p), this.mux.WINDOW_UNLOADING && t === "viewend") this.eventQueue.destroy(!0);
                    else {
                        ...
                        if (this.rateLimited) return n.event = "eventrateexceeded", p = he(n), this.eventQueue.queueEvent(n.event, p), q.error("Beaconing disabled due to rate limit.");
                    }
                }
            }
        },
        ...
        },
        {
            ...
            value: function(t, i) {
                ...
                if (o === "-1" || t === "viewstart" || t === "viewend" || !this.previousBeaconData || this.mux.utils.now() - this.lastEventTime >= vi) n = Z({}, i), o && (this.previousBeaconData = n), o && t === "viewend" && (this.previousBeaconData = null);
                else {
                    var s = t.indexOf("request") === 0;
                    Object.entries(i).forEach(function(u) {
                        var p = H(u, 2), y = p[0], x = p[1];
...
var hi = function r(e) {
    ...
    var t = 0, i = 0, a = 0, n = 0, o = 0, s = 0, u = 0, p = function(D, f) {
        var _1 = f.request_start, v = f.request_response_start, w = f.request_response_end, h = f.request_bytes_loaded;
        n++;
        var m, c;
        if (v ? (m = v - (_1 != null ? _1 : 0), c = (w != null ? w : 0) - v) : c = (w != null ? w : 0) - (_1 != null ? _1 : 0), c > 0 && h && h > 0) {
            var d = h / c * 8e3;
            o++, i += h, a += c, e.data.view_min_request_throughput = Math.min(e.data.view_min_request_throughput || 1 / 0, d), e.data.view_average_request_throughput = i / a * 8e3, e.data.view_request_count = n, m > 0 && (t += m, e.data.view_max_request_latency = Math.max(e.data.view_max_request_latency || 0, m), e.data.view_average_request_latency = t / o);
        }
    }, y = function(D, f) {
...
var yi = 60 * 60 * 1e3, gi = function r(e) {
    "use strict";
    var t = this;
    k(this, r), l(this, "_lastEventTime", void 0), e.on("before*", function(i, a) {
        var n = a.viewer_time, o = O.now(), s = t._lastEventTime;
        if (t._lastEventTime = o, s && o - s > yi) {
            var u = Object.keys(e.data).reduce(function(y, x) {
                return x.indexOf("video_") === 0 ? Object.assign(y, l({}, x, e.data[x])) : y;
            }, {});
...
var Ei = function(r) {
    ...
    "use strict";
    var t = this;
    k(this, r), l(this, "_emittingAutomaticEvent", !1), l(this, "_hasInitialized", !1), l(this, "_currentMode", "standard"), e.on("viewstart", function() {
...
var xi = function() {
    "use strict";
    function r(e) {
        k(this, r), l(this, "pm", void 0), l(this, "_currentRangeStart", void 0), l(this, "_lastPlayheadTime", void 0), this.pm = e, this._currentRangeStart = null, this._lastPlayheadTime = null, e.on("playbackheartbeat", this._updatePlaybackRange.bind(this)), e.on("playbackheartbeatend", this._endPlaybackRange.bind(this));
    }
    return N(r, [
        {
...
var se = G(Q()), Ri = function() {
    "use strict";
    function r(e) {
        var t = this;
        k(this, r), l(this, "pm", void 0), l(this, "lastType", void 0), l(this, "lastLowDataMode", void 0), this.pm = e, this.pm.one("viewinit", function() {
            var i, a = t.emit.bind(t);
            a(), se.default.addEventListener("online", a), se.default.addEventListener("offline", a), (i = r.connection) === null || i === void 0 || i.addEventListener("change", a), t.pm.on("destroy", function() {
                var n;
                (n = r.connection) === null || n === void 0 || n.removeEventListener("change", a), se.default.removeEventListener("online", a), se.default.removeEventListener("offline", a);
            });
        });
    }
    return N(r, [
        {
            ...
            get: function() {
                var t, i;
                return ((t = se.default.navigator) === null || t === void 0 ? void 0 : t.onLine) === !1 ? z.NO_CONNECTION : !((i = r.connection) === null || i === void 0) && i.type ? jr(r.connection.type) : z.UNKNOWN;
            }
        },
        {
            key: "lowDataMode",
        ...
        },
        {
            ...
            value: function() {
                ...
                t === this.lastType && i === this.lastLowDataMode || (this.lastType = t, this.lastLowDataMode = i, this.pm.emit("networkchange", Z({
                    viewer_connection_type: t
                }, i !== void 0 && {
                    viewer_connection_low_data_mode: i
                })));
            }
        }
    ], [
...
var Di = [
    ...
    function t(i, a, n) {
        ...
        var s = {
            ...
            errorTranslator: function(_1) {
                return _1;
            },
            emitTranslator: function() {
                for(var _1 = arguments.length, v = new Array(_1), w = 0; w < _1; w++)v[w] = arguments[w];
                return v;
            },
            stateDataTranslator: function(_1) {
                return _1;
            }
        };
        if (o.mux = i, o.id = a, n != null && n.beaconDomain && o.mux.log.warn("The `beaconDomain` setting has been deprecated in favor of `beaconCollectionDomain`. Please change your integration to use `beaconCollectionDomain` instead of `beaconDomain`."), n = Object.assign(s, n), n.data = n.data || {}, !1) var u, p;
        n.data.property_key && (n.data.env_key = n.data.property_key, delete n.data.property_key), q.level = n.debug ? X.DEBUG : X.WARN, o.getPlayheadTime = n.getPlayheadTime, o.getStateData = n.getStateData || function() {
            return {};
        ...
        if (o.on("viewinit", function(_1, v) {
        ...
        }), o.on("videochange", function(_1, v) {
            this._resetView(v);
        }), o.on("programchange", function(_1, v) {
            this.data.player_is_paused && this.mux.log.warn("The `programchange` event is intended to be used when the content changes mid playback without the video source changing, however the video is not currently playing. If the video source is changing please use the videochange event otherwise you will lose startup time information."), this._resetView(Object.assign(v, {
                view_program_changed: !0
            })), y(), this.emit("play"), this.emit("playing");
        }), o.on("fragmentchange", function(_1, v) {
            ...
            var x = function() {
                var _1 = typeof o.data.view_start != "undefined";
                o.mux.WINDOW_HIDDEN = document.visibilityState === "hidden", _1 && o.mux.WINDOW_HIDDEN && (o.data.player_is_paused || o.emit("hb"));
            };
            window.addEventListener("visibilitychange", x, !1);
            var D = function(_1) {
                _1.persisted || o.destroy();
            };
        ...
        o.on("playerready", function(_1, v) {
            Object.assign(this.data, v);
        }), Di.forEach(function(_1) {
            o.on(_1, function(v, w) {
                _1.indexOf("ad") !== 0 && this._updateStateData(), Object.assign(this.data, w), this._sanitizeData();
            }), o.on("after" + _1, function() {
                (_1 !== "error" || this.errorTracker.viewErrored) && this.send(_1);
            });
        }), o.on("viewend", function(_1, v) {
        ...
        return o.one("playerready", f), o.longResumeTracker = new Hr(b(o)), o.errorTracker = new Wt(b(o)), new er(b(o)), o.seekingTracker = new Xt(b(o)), o.playheadTime = new Gt(b(o)), o.playbackHeartbeat = new Ft(b(o)), new Yt(b(o)), o.watchTimeTracker = new jt(b(o)), new Vt(b(o)), new Wr(b(o)), o.adTracker = new Zt(b(o)), new zt(b(o)), new Qt(b(o)), new Kt(b(o)), new Mr(b(o)), new Ur(b(o)), new Fr(b(o)), new Gr(b(o)), n.hlsjs && o.addHLSJS(n), n.dashjs && o.addDashJS(n), o.emit("viewinit", n.data), o;
    }
    return N(t, [
        {
            key: "emit",
            value: function(a, n) {
                ...
                u != null && u.length && (o = Se($(t.prototype), "emit", this)).call.apply(o, [
                    this
                ].concat(W(u)));
            }
        },
        ...
        },
        {
            ...
            value: function(a) {
                if (this.data.view_id) {
                    ...
                    if (n.video_source_is_live === void 0 && (n.player_source_duration === 1 / 0 || n.video_source_duration === 1 / 0 ? n.video_source_is_live = !0 : (n.player_source_duration > 0 || n.video_source_duration > 0) && (n.video_source_is_live = !1)), n.video_source_is_live || o.forEach(function(y) {
                        n[y] = void 0;
                    }), n.video_source_url = n.video_source_url || n.player_source_url, n.video_source_url) {
                        var s = H(ie(n.video_source_url), 2), u = s[0], p = s[1];
        ...
        },
        {
            ...
            value: function() {
                var a = this, n = this.data.view_id = re(), o = function() {
        ...
        },
        {
            ...
            value: function(a) {
                ...
                this.dashjs = a.dashjs, Mt(this.mux, this.id, a.dashjs);
            }
        },
        {
            key: "removeDashJS",
...
function ut(r, e, t) {
    var i = H(de(e), 3), a = i[0], n = i[1], o = i[2], s = r.log, u = r.utils.getComputedStyle, p = r.utils.secondsToMs, y = {
    ...
    var x = {
        ...
        getStateData: function() {
            var _1, v, w, h = ((_1 = (v = this).getPlayheadTime) === null || _1 === void 0 ? void 0 : _1.call(v)) || p(a.currentTime), m = this.hlsjs && this.hlsjs.url, c = this.dashjs && typeof this.dashjs.getSource == "function" && this.dashjs.getSource(), d = {
            ...
            if (a.getStartDate && h > 0) {
                ...
                if (g && typeof g.getTime == "function" && g.getTime()) {
                    var T = g.getTime();
                    if (d.player_program_time = T + h, a.seekable.length > 0) {
    ...
    a.mux.destroy = function() {
        ...
        var _1 = H(de(f), 3), v = _1[0], w = _1[1], h = _1[2];
        if (v) {
        ...
        f === "error" && !t.automaticErrorTracking || (a.mux.listeners[f] = function() {
            ...
            if (f === "error") {
                ...
                _1.player_error_code = a.error.code, _1.player_error_message = Oi[a.error.code] || a.error.message;
            }
            r.emit(n, f, _1);
        ...
        var f = Pe(), _1 = document.fullscreenElement;
        if (f && (_1 === a || _1 != null && _1.contains(a))) r.emit(n, "playbackmodechange", {
            player_playback_mode: "fullscreen",
            player_playback_mode_data: "{}"
        });
        else if (!f) {
            var v = document.pictureInPictureElement === a, w = v ? "pip" : "standard";
            r.emit(n, "playbackmodechange", {
...
var we = G(Q()), be;
we.default && we.default.WeakMap && (be = new WeakMap);
function dt(r, e) {
    if (!r || !e || !we.default || typeof we.default.getComputedStyle != "function") return "";
    var t;
    return be && be.has(r) && (t = be.get(r)), t || (t = we.default.getComputedStyle(r, null), be && be.set(r, t)), t.getPropertyValue(e);
}
function ct(r) {
...
Ve.prototype.processLine = function(r) {
    var e = r.indexOf(":"), t = Ni(r, e), i = t[0], a = t.length === 2 ? ft(t[1]) : void 0;
    if (i[0] !== "#") this.currentUri.uri = i, this.manifest.segments.push(this.currentUri), this.manifest.targetDuration && !("duration" in this.currentUri) && (this.currentUri.duration = this.manifest.targetDuration), this.currentUri = {};
        ...
        case _e.PART_INF:
            {
                _t(this.manifest, t), this.manifest.partInf.partTarget && (this.manifest.partTargetDuration = this.manifest.partInf.partTarget), this.setHoldBack();
                break;
            }
        case _e.SERVER_CONTROL:
            {
                _t(this.manifest, t), this.setHoldBack();
                break;
            }
        case _e.INF:
            {
...
var _t = function(r, e) {
    ...
    Ii(e[1]) ? (i = {}, i = Object.assign(Li(e[1]), i)) : i = ft(e[1]), r[t] = i;
}, Qr = function(r) {
...
var Mi = {
    ...
    headersStringToObject: ve,
    cdnHeadersToRequestId: ce,
    extractHostnameAndDomain: ie,
    extractHostname: F,
    manifestParser: zr,
    generateShortID: Ie,
    generateUUID: re,
...
var Bi = "mux-embed", Ui = "5.18.1", Fi = "2.1", M = {}, ue = function(e) {
    var t = arguments;
    typeof e == "string" ? ue.hasOwnProperty(e) ? Te.default.setTimeout(function() {
        t = Array.prototype.splice.call(t, 1), ue[e].apply(null, t);
    ...
    init: function(e, t) {
        fe() && t && t.respectDoNotTrack && q.info("The browser's Do Not Track flag is enabled - Mux beaconing is disabled.");
        var i = J(e);
        M[i] = new Jr(ue, i, t);
    },
    emit: function(e, t, i) {
...
Object.assign(ue, Wi);
typeof Te.default != "undefined" && typeof Te.default.addEventListener == "function" && Te.default.addEventListener("pagehide", function(r) {
    r.persisted || (ue.WINDOW_UNLOADING = !0);
}, !1);
var Zl = ue;
;
 /*!
